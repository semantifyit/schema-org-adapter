...
"use strict";var util=require("./utilities");class Property{constructor(r,e){this.IRI=r,this.graph=e}getIRI(){return arguments.length>0&&void 0!==arguments[0]&&arguments[0]?this.IRI:util.toAbsoluteIRI(this.IRI,this.graph.context)}getTermType(){return"rdf:Property"}getVocabulary(){var r=this.graph.properties[this.IRI];return void 0!==r["schema:isPartOf"]?r["schema:isPartOf"]:null}getSource(){var r=this.graph.properties[this.IRI];return void 0!==r["dc:source"]?r["dc:source"]:null}isSupersededBy(){var r=this.graph.properties[this.IRI];return util.isString(r["schema:supersededBy"])?r["schema:supersededBy"]:null}getName(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"en",e=this.graph.properties[this.IRI]["rdfs:label"];return null===e||void 0===e[r]?null:e[r]}getDescription(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"en",e=this.graph.properties[this.IRI]["rdfs:comment"];return null===e||void 0===e[r]?null:e[r]}getRanges(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.graph.properties[this.IRI],i=[];if(i.push(...t["schema:rangeIncludes"]),!0===r){for(var s=[],h=0;h<i.length;h++)s.push(...this.graph.reasoner.inferImplicitSubClasses(i[h]));i.push(...s),i=i.filter(function(r){return null!==r})}return util.applyFilter(util.uniquifyArray(i),e,this.graph)}getDomains(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.graph.properties[this.IRI],i=[];if(i.push(...t["schema:domainIncludes"]),!0===r){for(var s=[],h=0;h<i.length;h++)s.push(...this.graph.reasoner.inferImplicitSubClasses(i[h]));i.push(...s)}return util.applyFilter(util.uniquifyArray(i),e,this.graph)}getSuperProperties(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.graph.properties[this.IRI],i=[];return!0===r?i.push(...this.graph.reasoner.inferSuperProperties(this.IRI)):i.push(...t["rdfs:subPropertyOf"]),util.applyFilter(util.uniquifyArray(i),e,this.graph)}getSubProperties(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t=this.graph.properties[this.IRI],i=[];return!0===r?i.push(...this.graph.reasoner.inferSubProperties(this.IRI)):i.push(...t["soa:superPropertyOf"]),util.applyFilter(util.uniquifyArray(i),e,this.graph)}toString(){return JSON.stringify(this.toJSON(!1,null),null,2)}toJSON(){var r=!(arguments.length>0&&void 0!==arguments[0])||arguments[0],e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,t={};return t.id=this.getIRI(!0),t.IRI=this.getIRI(),t.type=this.getTermType(),t.vocabulary=this.getVocabulary(),t.source=this.getSource(),t.supersededBy=this.isSupersededBy(),t.name=this.getName(),t.description=this.getDescription(),t.ranges=this.getRanges(r,e),t.domains=this.getDomains(r,e),t.superProperties=this.getSuperProperties(r,e),t.subProperties=this.getSubProperties(r,e),t}}module.exports=Property;
...
"use strict";function asyncGeneratorStep(t,e,r,a,n,s,i){try{var o=t[s](i),l=o.value}catch(t){return void r(t)}o.done?e(l):Promise.resolve(l).then(a,n)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(a,n){var s=t.apply(e,r);function i(t){asyncGeneratorStep(s,a,n,i,o,"next",t)}function o(t){asyncGeneratorStep(s,a,n,i,o,"throw",t)}i(void 0)})}}var Graph=require("./Graph"),util=require("./utilities"),axios=require("axios");class SDOAdapter{constructor(){this.graph=new Graph(this)}addVocabularies(t){var e=arguments,r=this;return _asyncToGenerator(function*(){var a=e.length>1&&void 0!==e[1]?e[1]:null;if(!util.isArray(t))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD)");for(var n=0;n<t.length;n++)if(util.isString(t[n]))if(t[n].startsWith("www")||t[n].startsWith("http")){var s=yield r.fetchVocabularyFromURL(t[n]);try{yield r.graph.addVocabulary(s)}catch(e){console.log("The given URL "+t[n]+" did not contain a valid JSON-LD vocabulary.")}}else try{yield r.graph.addVocabulary(JSON.parse(t[n]))}catch(t){console.log("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!util.isObject(t[n]))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD as Object/String)");yield r.graph.addVocabulary(t[n])}null!==a&&a()})()}fetchVocabularyFromURL(t){return _asyncToGenerator(function*(){try{return new Promise(function(e,r){axios.get(t).then(function(t){e(t.data)}).catch(function(t){r(console.log(t))})})}catch(t){return console.log(t),""}})()}getClass(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getClass(t,e)}getAllClasses(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfClasses(t),r=[],a=0;a<e.length;a++)try{r.push(this.getClass(e[a]))}catch(t){}return r}getListOfClasses(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.classes),t,this.graph)}getProperty(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getProperty(t,e)}getAllProperties(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfProperties(t),r=[],a=0;a<e.length;a++)try{r.push(this.getProperty(e[a]))}catch(t){}return r}getListOfProperties(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.properties),t,this.graph)}getDataType(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getDataType(t,e)}getAllDataTypes(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfDataTypes(t),r=[],a=0;a<e.length;a++)try{r.push(this.getDataType(e[a]))}catch(t){}return r}getListOfDataTypes(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.dataTypes),t,this.graph)}getEnumeration(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumeration(t,e)}getAllEnumerations(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfEnumerations(t),r=[],a=0;a<e.length;a++)try{r.push(this.getEnumeration(e[a]))}catch(t){}return r}getListOfEnumerations(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerations),t,this.graph)}getEnumerationMember(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumerationMember(t,e)}getAllEnumerationMembers(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfEnumerationMembers(t),r=[],a=0;a<e.length;a++)try{r.push(this.getEnumerationMember(e[a]))}catch(t){}return r}getListOfEnumerationMembers(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerationMembers),t,this.graph)}getVocabularies(){for(var t=Object.keys(this.graph.context),e={},r=["soa","xsd","rdf","rdfa","rdfs","dc"],a=0;a<t.length;a++)util.isString(this.graph.context[t[a]])&&-1===r.indexOf(t[a])&&(e[t[a]]=this.graph.context[t[a]]);return e}getSDOVocabularyURL(){var t=arguments;return _asyncToGenerator(function*(){var e=t.length>0&&void 0!==t[0]?t[0]:"latest",r=t.length>1&&void 0!==t[1]?t[1]:"schema";return new Promise(function(t,a){"latest"===e?axios.get("https://raw.githubusercontent.com/schemaorg/schemaorg/master/versions.json").then(function(a){e=a.data.schemaversion,t("https://raw.githubusercontent.com/schemaorg/schemaorg/master/data/releases/"+e+"/"+r+".jsonld")}).catch(function(t){a(console.log(t))}):t("https://raw.githubusercontent.com/schemaorg/schemaorg/master/data/releases/"+e+"/"+r+".jsonld")})})()}}module.exports=SDOAdapter;

},{"./Graph":79,"./utilities":83,"axios":1}],83:[function(require,module,exports){
"use strict";function asyncGeneratorStep(r,e,s,t,a,n,i){try{var o=r[n](i),f=o.value}catch(r){return void s(r)}o.done?e(f):Promise.resolve(f).then(t,a)}function _asyncToGenerator(r){return function(){var e=this,s=arguments;return new Promise(function(t,a){var n=r.apply(e,s);function i(r){asyncGeneratorStep(n,t,a,i,o,"next",r)}function o(r){asyncGeneratorStep(n,t,a,i,o,"throw",r)}i(void 0)})}}var jsonld=require("jsonld");function applyFilter(r,e,s){if(!Array.isArray(r)||0===r.length||null===e||0===Object.keys(e).length)return r;for(var t=[],a=0;a<r.length;a++){var n=s.getTerm(r[a]);if(void 0!==e.isSuperseded){if(!1===e.isSuperseded&&null!==n.isSupersededBy())continue;if(!0===e.isSuperseded&&null===n.isSupersededBy())continue}if(void 0!==e.fromVocabulary){var i=!1;if(isString(e.fromVocabulary))n.getIRI(!0).startsWith(e.fromVocabulary)&&(i=!0);else if(isArray(e.fromVocabulary))for(var o=0;o<e.fromVocabulary.length;o++)n.getIRI(!0).startsWith(e.fromVocabulary[o])&&(i=!0);if(!i)continue}if(void 0!==e.termType){var f=!1,l=[];isString(e.termType)?l.push(e.termType):isArray(e.termType)&&(l=e.termType);for(var c=0;c<l.length;c++){var u=void 0;switch(l[c]){case"Class":u="rdfs:Class";break;case"Property":u="rdf:Property";break;case"Enumeration":u="schema:Enumeration";break;case"EnumerationMember":u="soa:EnumerationMember";break;case"DataType":u="schema:DataType";break;default:console.log("Invalid filter.termType "+l[c])}if(u===n.getTermType()){f=!0;break}}if(!f)continue}t.push(r[a])}return t}function copByVal(r){if(void 0!==r)return JSON.parse(JSON.stringify(r))}function isObject(r){return!Array.isArray(r)&&(null!=r&&"object"==typeof r)}function isString(r){return null!=r&&("string"==typeof r||r instanceof String)}function isArray(r){return Array.isArray(r)}function uniquifyArray(r){for(var e={},s=[],t=0;t<r.length;t++){var a=r[t];1!==e[a]&&(e[a]=1,s.push(a))}return s}function generateContext(r,e){for(var s=Object.keys(r),t=Object.keys(e),a=JSON.parse(JSON.stringify(r)),n=0;n<t.length;n++){var i=t[n];if(isString(e[i])){for(var o=!1,f=0;f<s.length;f++)if(isString(a[s[f]])&&a[s[f]]===e[i]){o=!0;break}if(o)continue;if(void 0===a[i])a[i]=e[i];else if(a[i]!==e[i])for(var l=!1,c=1;!1===l;){var u=i+c++;void 0===a[u]&&(l=!0,a[u]=e[i])}}}var d={};Object.keys(a).sort().forEach(function(r){d[r]=a[r]}),a=d;for(var y=Object.keys(a),p={},m=0;m<y.length;m++)isString(a[y[m]])&&(p[y[m]]=a[y[m]]);for(var g=0;g<y.length;g++)isObject(a[y[g]])&&(p[y[g]]=a[y[g]]);return p}function preProcessVocab(r,e){return _preProcessVocab.apply(this,arguments)}function _preProcessVocab(){return(_preProcessVocab=_asyncToGenerator(function*(r,e){var s=!1;do{var t=[];s=!1;for(var a=0;a<r["@graph"].length;a++)void 0!==r["@graph"][a]["@graph"]?(t.push(...copByVal(r["@graph"][a]["@graph"])),s=!0):t.push(copByVal(r["@graph"][a]));r["@graph"]=copByVal(t)}while(!0===s);var n=yield jsonld.expand(r),i=yield jsonld.compact(n,e);return void 0===i["@graph"]?(delete i["@context"],{"@context":e,"@graph":[i]}):i})).apply(this,arguments)}function curateNode(r,e){if(void 0!==r["rdfs:comment"]){if(isString(r["rdfs:comment"]))r["rdfs:comment"]={en:r["rdfs:comment"]};else if(isObject(r["rdfs:comment"])){var s={};s[r["rdfs:comment"]["@language"]]=r["rdfs:comment"]["@value"],r["rdfs:comment"]=copByVal(s)}else if(isArray(r["rdfs:comment"])){for(var t={},a=0;a<r["rdfs:comment"].length;a++)isObject(r["rdfs:comment"][a])&&(t[r["rdfs:comment"][a]["@language"]]=r["rdfs:comment"][a]["@value"]);r["rdfs:comment"]=copByVal(t)}}else r["rdfs:comment"]={};if(void 0!==r["rdfs:label"]){if(isString(r["rdfs:label"]))r["rdfs:label"]={en:r["rdfs:label"]};else if(isObject(r["rdfs:label"])){var n={};n[r["rdfs:label"]["@language"]]=r["rdfs:label"]["@value"],r["rdfs:label"]=copByVal(n)}else if(isArray(r["rdfs:label"])){for(var i={},o=0;o<r["rdfs:label"].length;o++)isObject(r["rdfs:label"][o])&&(i[r["rdfs:label"][o]["@language"]]=r["rdfs:label"][o]["@value"]);r["rdfs:label"]=copByVal(i)}}else r["rdfs:label"]={};if(isString(r["rdfs:subClassOf"])?r["rdfs:subClassOf"]=[r["rdfs:subClassOf"]]:void 0===r["rdfs:subClassOf"]&&"rdfs:Class"===r["@type"]&&(r["rdfs:subClassOf"]=[]),isString(r["rdfs:subPropertyOf"])?r["rdfs:subPropertyOf"]=[r["rdfs:subPropertyOf"]]:void 0===r["rdfs:subPropertyOf"]&&"rdf:Property"===r["@type"]&&(r["rdfs:subPropertyOf"]=[]),isString(r["schema:domainIncludes"])?r["schema:domainIncludes"]=[r["schema:domainIncludes"]]:void 0===r["schema:domainIncludes"]&&"rdf:Property"===r["@type"]&&(r["schema:domainIncludes"]=[]),isString(r["schema:rangeIncludes"])?r["schema:rangeIncludes"]=[r["schema:rangeIncludes"]]:void 0===r["schema:rangeIncludes"]&&"rdf:Property"===r["@type"]&&(r["schema:rangeIncludes"]=[]),!isString(r["schema:isPartOf"])){for(var f,l=Object.keys(e),c=0;c<l.length;c++)if(r["@id"].substring(0,r["@id"].indexOf(":"))===l[c]){f=e[l[c]];break}if(void 0!==f){var u;do{u=!1,(f.endsWith("/")||f.endsWith("#"))&&(f=f.substring(0,f.length-1),u=!0)}while(!0===u);r["schema:isPartOf"]=f}}return r}function toCompactIRI(r,e){for(var s=Object.keys(e),t=0;t<s.length;t++){var a=e[s[t]];if(isString(a)&&r.startsWith(a))return s[t]+":"+r.substring(a.length)}return null}function toAbsoluteIRI(r,e){for(var s=Object.keys(e),t=0;t<s.length;t++){var a=e[s[t]];if(r.substring(0,r.indexOf(":"))===s[t])return a.concat(r.substring(r.indexOf(":")+1))}return null}module.exports={applyFilter:applyFilter,copByVal:copByVal,isArray:isArray,isString:isString,isObject:isObject,uniquifyArray:uniquifyArray,preProcessVocab:preProcessVocab,generateContext:generateContext,curateNode:curateNode,toCompactIRI:toCompactIRI,toAbsoluteIRI:toAbsoluteIRI};
