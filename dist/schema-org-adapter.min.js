...
"use strict";function asyncGeneratorStep(t,e,r,n,a,s,i){try{var o=t[s](i),h=o.value}catch(t){return void r(t)}o.done?e(h):Promise.resolve(h).then(n,a)}function _asyncToGenerator(t){return function(){var e=this,r=arguments;return new Promise(function(n,a){var s=t.apply(e,r);function i(t){asyncGeneratorStep(s,n,a,i,o,"next",t)}function o(t){asyncGeneratorStep(s,n,a,i,o,"throw",t)}i(void 0)})}}var Graph=require("./Graph"),util=require("./utilities"),axios=require("axios");class SDOAdapter{constructor(){this.graph=new Graph(this)}addVocabularies(t){var e=this;return _asyncToGenerator(function*(){if(!util.isArray(t))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD)");for(var r=0;r<t.length;r++)if(util.isString(t[r]))if(t[r].startsWith("www")||t[r].startsWith("http")){var n=yield e.fetchVocabularyFromURL(t[r]);try{yield e.graph.addVocabulary(n)}catch(e){console.log("The given URL "+t[r]+" did not contain a valid JSON-LD vocabulary.")}}else try{yield e.graph.addVocabulary(JSON.parse(t[r]))}catch(t){console.log("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!util.isObject(t[r]))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD as Object/String)");yield e.graph.addVocabulary(t[r])}})()}fetchVocabularyFromURL(t){return _asyncToGenerator(function*(){try{return new Promise(function(e,r){axios.get(t).then(function(t){e(t.data)}).catch(function(t){r(console.log(t))})})}catch(t){return console.log(t),""}})()}getClass(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getClass(t,e)}getAllClasses(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfClasses(t),r=[],n=0;n<e.length;n++)try{r.push(this.getClass(e[n]))}catch(t){throw new Error("There is no class with the IRI "+e[n])}return r}getListOfClasses(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.classes),t,this.graph)}getProperty(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getProperty(t,e)}getAllProperties(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfProperties(t),r=[],n=0;n<e.length;n++)try{r.push(this.getProperty(e[n]))}catch(t){throw new Error("There is no property with the IRI "+e[n])}return r}getListOfProperties(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.properties),t,this.graph)}getDataType(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getDataType(t,e)}getAllDataTypes(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfDataTypes(t),r=[],n=0;n<e.length;n++)try{r.push(this.getDataType(e[n]))}catch(t){throw new Error("There is no data type with the IRI "+e[n])}return r}getListOfDataTypes(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.dataTypes),t,this.graph)}getEnumeration(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumeration(t,e)}getAllEnumerations(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfEnumerations(t),r=[],n=0;n<e.length;n++)try{r.push(this.getEnumeration(e[n]))}catch(t){throw new Error("There is no enumeration with the IRI "+e[n])}return r}getListOfEnumerations(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerations),t,this.graph)}getEnumerationMember(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumerationMember(t,e)}getAllEnumerationMembers(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,e=this.getListOfEnumerationMembers(t),r=[],n=0;n<e.length;n++)try{r.push(this.getEnumerationMember(e[n]))}catch(t){throw new Error("There is no enumeration member with the IRI "+e[n])}return r}getListOfEnumerationMembers(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerationMembers),t,this.graph)}getVocabularies(){for(var t=Object.keys(this.graph.context),e={},r=["soa","xsd","rdf","rdfa","rdfs","dc"],n=0;n<t.length;n++)util.isString(this.graph.context[t[n]])&&-1===r.indexOf(t[n])&&(e[t[n]]=this.graph.context[t[n]]);return e}constructSDOVocabularyURL(){var t=arguments,e=this;return _asyncToGenerator(function*(){var r=t.length>0&&void 0!==t[0]?t[0]:"latest",n=t.length>1&&void 0!==t[1]?t[1]:"schema";return"latest"===r?"https://raw.githubusercontent.com/schemaorg/schemaorg/master/data/releases/"+(yield e.getLatestSDOVersion())+"/"+n+".jsonld":"https://raw.githubusercontent.com/schemaorg/schemaorg/master/data/releases/"+r+"/"+n+".jsonld"})()}getLatestSDOVersion(){return _asyncToGenerator(function*(){return new Promise(function(t,e){axios.get("https://raw.githubusercontent.com/schemaorg/schemaorg/master/versions.json").then(function(e){t(e.data.schemaversion)}).catch(function(t){e(console.log(t))})})})()}}module.exports=SDOAdapter;
