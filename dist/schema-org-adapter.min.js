...
class ReasoningEngine{constructor(s){this.graph=s,this.util=_dereq_("./utilities")}inferPropertiesFromSuperClasses(s){const t=[];for(const i of s){let s=this.graph.classes[i]||this.graph.enumerations[i];s&&(t.push(...s["soa:hasProperty"]),0!==s["rdfs:subClassOf"].length&&t.push(...this.inferPropertiesFromSuperClasses(s["rdfs:subClassOf"])))}return this.util.uniquifyArray(t)}inferSuperClasses(s){let t=[];const i=this.graph.classes[s]||this.graph.enumerations[s];if(i){t.push(...i["rdfs:subClassOf"]);let s=this.util.copByVal(t);do{let i=[];for(const t of s){let s=this.graph.classes[t]||this.graph.enumerations[t];s&&i.push(...s["rdfs:subClassOf"])}i=this.util.uniquifyArray(i),s=this.util.copByVal(i),t.push(...i)}while(0!==s.length);t=this.util.uniquifyArray(t)}return t}inferSubClasses(s){let t=[];const i=this.graph.classes[s]||this.graph.enumerations[s];if(i){t.push(...i["soa:superClassOf"]);let s=this.util.copByVal(t);do{let i=[];for(const t of s){let s=this.graph.classes[t]||this.graph.enumerations[t];s&&i.push(...s["soa:superClassOf"])}i=this.util.uniquifyArray(i),s=this.util.copByVal(i),t.push(...i)}while(0!==s.length);t=this.util.uniquifyArray(t)}return t}inferSuperDataTypes(s){let t=[];const i=this.graph.dataTypes[s];if(i){t.push(...i["rdfs:subClassOf"]);let s=this.util.copByVal(t);do{let i=[];for(const t of s){const s=this.graph.dataTypes[t];s&&i.push(...s["rdfs:subClassOf"])}i=this.util.uniquifyArray(i),s=this.util.copByVal(i),t.push(...i)}while(0!==s.length);t=this.util.uniquifyArray(t)}return t}inferSubDataTypes(s){let t=[];const i=this.graph.dataTypes[s];if(i){t.push(...i["soa:superClassOf"]);let s=this.util.copByVal(t);do{let i=[];for(const t of s){const s=this.graph.dataTypes[t];s&&i.push(...s["soa:superClassOf"])}i=this.util.uniquifyArray(i),s=this.util.copByVal(i),t.push(...i)}while(0!==s.length);t=this.util.uniquifyArray(t)}return t}inferSuperProperties(s){let t=[];const i=this.graph.properties[s];if(i){t.push(...i["rdfs:subPropertyOf"]);let s=this.util.copByVal(t);do{let i=[];for(let t of s){const s=this.graph.properties[t];s&&i.push(...s["rdfs:subPropertyOf"])}i=this.util.uniquifyArray(i),s=this.util.copByVal(i),t.push(...i)}while(0!==s.length);t=this.util.uniquifyArray(t)}return t}inferSubProperties(s){let t=[];const i=this.graph.properties[s];if(i){t.push(...i["soa:superPropertyOf"]);let s=this.util.copByVal(t);do{let i=[];for(const t of s){const s=this.graph.properties[t];s&&i.push(...s["soa:superPropertyOf"])}i=this.util.uniquifyArray(i),s=this.util.copByVal(i),t.push(...i)}while(0!==s.length);t=this.util.uniquifyArray(t)}return t}inferRangeOf(s){const t=this.graph.classes[s]||this.graph.enumerations[s];let i=[];if(t){i.push(...t["soa:isRangeOf"]);let r=this.inferSuperClasses(s);for(const s of r){let t=this.graph.classes[s]||this.graph.enumerations[s];t&&i.push(...t["soa:isRangeOf"])}}else{const t=this.graph.dataTypes[s];if(t){i.push(...t["soa:isRangeOf"]);let r=this.inferSuperDataTypes(s);for(const s of r){let t=this.graph.dataTypes[s];t&&i.push(...t["soa:isRangeOf"])}}}return this.util.uniquifyArray(i)}}module.exports=ReasoningEngine;
