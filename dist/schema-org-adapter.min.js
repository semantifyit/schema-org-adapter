...
"use strict";var __awaiter=this&&this.__awaiter||function(s,e,t,a){return new(t||(t=Promise))(function(i,n){function r(s){try{c(a.next(s))}catch(s){n(s)}}function o(s){try{c(a.throw(s))}catch(s){n(s)}}function c(s){var e;s.done?i(s.value):(e=s.value,e instanceof t?e:new t(function(s){s(e)})).then(r,o)}c((a=a.apply(s,e||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Graph=void 0;const Class_1=_dereq_("./Class"),Property_1=_dereq_("./Property"),Enumeration_1=_dereq_("./Enumeration"),EnumerationMember_1=_dereq_("./EnumerationMember"),DataType_1=_dereq_("./DataType"),utilities_1=_dereq_("./utilities"),namespaces_1=_dereq_("./namespaces"),graphUtilities_1=_dereq_("./graphUtilities"),reasoning_1=_dereq_("./reasoning");class Graph{constructor(s){this.sdoAdapter=s,this.context=(0,graphUtilities_1.getStandardContext)(),this.classes={},this.properties={},this.dataTypes={},this.enumerations={},this.enumerationMembers={}}addVocabulary(s,e){return __awaiter(this,void 0,void 0,function*(){void 0===this.context.schema&&(this.context.schema=(0,graphUtilities_1.discoverUsedSchemaOrgProtocol)(s)+"://schema.org/");try{if(this.sdoAdapter.equateVocabularyProtocols){const e=(0,graphUtilities_1.discoverEquateNamespaces)(this.context,s);if(e.length>0){const t=(0,utilities_1.cloneJson)(s["@context"]);e.forEach(s=>{const e=Object.keys(t).find(e=>t[e]===s);e&&delete t[e];const a=Object.keys(this.context).find(e=>this.context[e]===(0,utilities_1.switchIRIProtocol)(s));t[a]=s}),s=yield(0,graphUtilities_1.preProcessVocab)(s,t),e.forEach(e=>{const t=Object.keys(this.context).find(s=>this.context[s]===(0,utilities_1.switchIRIProtocol)(e));s["@context"][t]=this.context[t]})}}this.context=(0,graphUtilities_1.generateContext)(this.context,s["@context"]),s=yield(0,graphUtilities_1.preProcessVocab)(s,this.context);const t=this.sdoAdapter.getVocabularies();for(let e of s["@graph"])e=(0,graphUtilities_1.curateVocabNode)(e,t);for(let t=0;t<s["@graph"].length;t++){const a=(0,utilities_1.cloneJson)(s["@graph"][t]);if((0,utilities_1.isString)(a["@type"]))switch(a["@type"]){case namespaces_1.TermTypeIRI.class:this.addGraphNode(this.classes,a,e);break;case namespaces_1.TermTypeIRI.property:this.addGraphNode(this.properties,a,e);break;default:this.addGraphNode(this.enumerationMembers,a,e)}else(0,utilities_1.isArray)(a["@type"])?a["@type"].includes(namespaces_1.TermTypeIRI.class)&&a["@type"].includes(namespaces_1.TermTypeIRI.dataType)?this.addGraphNode(this.dataTypes,a,e):this.addGraphNode(this.enumerationMembers,a,e):this.sdoAdapter.onError("unexpected @type format for the following node: "+JSON.stringify(a,null,2))}let a,i;do{a=!1;const s=Object.keys(this.classes),t=Object.keys(this.enumerations);for(const i of s)if(void 0!==this.classes[i][namespaces_1.RDFS.subClassOf]){const s=this.classes[i][namespaces_1.RDFS.subClassOf];for(const n of s)(n===namespaces_1.TermTypeIRI.enumeration||t.includes(n))&&(this.classes[i]&&!this.enumerations[i]?(a=!0,this.enumerations[i]=(0,utilities_1.cloneJson)(this.classes[i]),delete this.classes[i]):this.classes[i]&&this.enumerations[i]&&(a=!0,this.addGraphNode(this.enumerations,this.classes[i],e),delete this.classes[i]))}}while(a);do{i=!1;const s=Object.keys(this.classes),t=Object.keys(this.dataTypes);for(const a of s)if(void 0!==this.classes[a][namespaces_1.RDFS.subClassOf]){const s=this.classes[a][namespaces_1.RDFS.subClassOf];for(const n of s)(n===namespaces_1.TermTypeIRI.dataType||t.includes(n))&&(this.classes[a]&&!this.dataTypes[a]?(i=!0,this.dataTypes[a]=(0,utilities_1.cloneJson)(this.classes[a]),delete this.classes[a]):this.classes[a]&&this.dataTypes[a]&&(i=!0,this.addGraphNode(this.dataTypes,this.classes[a],e),delete this.classes[a]))}}while(i);const n=Object.keys(this.dataTypes);for(const s of n)this.dataTypes[s]["@type"]=namespaces_1.TermTypeIRI.dataType;let r=Object.keys(this.classes);for(const s of r){const e=this.classes[s][namespaces_1.RDFS.subClassOf];this.classes[s][namespaces_1.SOA.superClassOf]||(this.classes[s][namespaces_1.SOA.superClassOf]=[]);for(const t of e){let e=this.classes[t];e||(e=this.enumerations[t]),e&&(e[namespaces_1.SOA.superClassOf]?e[namespaces_1.SOA.superClassOf].includes(s)||e[namespaces_1.SOA.superClassOf].push(s):e[namespaces_1.SOA.superClassOf]=[s])}}let o=Object.keys(this.enumerations);for(const s of o){const e=this.enumerations[s][namespaces_1.RDFS.subClassOf];this.enumerations[s][namespaces_1.SOA.superClassOf]||(this.enumerations[s][namespaces_1.SOA.superClassOf]=[]);for(const t of e){let e=this.classes[t];e||(e=this.enumerations[t]),e&&(e[namespaces_1.SOA.superClassOf]?e[namespaces_1.SOA.superClassOf].includes(s)||e[namespaces_1.SOA.superClassOf].push(s):e[namespaces_1.SOA.superClassOf]=[s])}}let c=Object.keys(this.dataTypes);for(const s of c){const e=this.dataTypes[s][namespaces_1.RDFS.subClassOf];if(this.dataTypes[s][namespaces_1.SOA.superClassOf]||(this.dataTypes[s][namespaces_1.SOA.superClassOf]=[]),e)for(const t of e){const e=this.dataTypes[t];e&&(e[namespaces_1.SOA.superClassOf]?e[namespaces_1.SOA.superClassOf].includes(s)||e[namespaces_1.SOA.superClassOf].push(s):e[namespaces_1.SOA.superClassOf]=[s])}else this.dataTypes[s][namespaces_1.RDFS.subClassOf]=[]}let p=Object.keys(this.properties);for(const s of p){const e=this.properties[s][namespaces_1.RDFS.subPropertyOf];if(this.properties[s][namespaces_1.SOA.superPropertyOf]||(this.properties[s][namespaces_1.SOA.superPropertyOf]=[]),e)for(const t of e){const e=this.properties[t];e&&(e[namespaces_1.SOA.superPropertyOf]?e[namespaces_1.SOA.superPropertyOf].includes(s)||e[namespaces_1.SOA.superPropertyOf].push(s):e[namespaces_1.SOA.superPropertyOf]=[s])}else this.properties[s][namespaces_1.RDFS.subPropertyOf]=[]}r=Object.keys(this.classes);for(const s of r)this.classes[s][namespaces_1.SOA.hasProperty]||(this.classes[s][namespaces_1.SOA.hasProperty]=[]),this.classes[s][namespaces_1.SOA.isRangeOf]||(this.classes[s][namespaces_1.SOA.isRangeOf]=[]);o=Object.keys(this.enumerations);for(const s of o)this.enumerations[s][namespaces_1.SOA.hasEnumerationMember]||(this.enumerations[s][namespaces_1.SOA.hasEnumerationMember]=[]),this.enumerations[s][namespaces_1.SOA.isRangeOf]||(this.enumerations[s][namespaces_1.SOA.isRangeOf]=[]),this.enumerations[s][namespaces_1.SOA.hasProperty]||(this.enumerations[s][namespaces_1.SOA.hasProperty]=[]);c=Object.keys(this.dataTypes);for(const s of c)this.dataTypes[s][namespaces_1.SOA.isRangeOf]||(this.dataTypes[s][namespaces_1.SOA.isRangeOf]=[]);let h=Object.keys(this.enumerationMembers);for(const s of h)this.enumerationMembers[s][namespaces_1.SOA.enumerationDomainIncludes]||(this.enumerationMembers[s][namespaces_1.SOA.enumerationDomainIncludes]=[]);p=Object.keys(this.properties);for(const s of p){const e=this.properties[s][namespaces_1.SCHEMA.domainIncludes];if((0,utilities_1.isArray)(e))for(const t of e){let e=this.classes[t];e||(e=this.enumerations[t]),e&&(0,utilities_1.isArray)(e[namespaces_1.SOA.hasProperty])&&!e[namespaces_1.SOA.hasProperty].includes(s)&&e[namespaces_1.SOA.hasProperty].push(s)}const t=this.properties[s][namespaces_1.SCHEMA.rangeIncludes];if((0,utilities_1.isArray)(t))for(const e of t){const t=this.classes[e]||this.enumerations[e]||this.dataTypes[e];t&&(0,utilities_1.isArray)(t[namespaces_1.SOA.isRangeOf])&&!t[namespaces_1.SOA.isRangeOf].includes(s)&&t[namespaces_1.SOA.isRangeOf].push(s)}}h=Object.keys(this.enumerationMembers);for(const s of h){const e=this.enumerationMembers[s];let t=e["@type"];(0,utilities_1.isArray)(t)||(t=[t]);for(const a of t){const t=this.enumerations[a];t&&(0,utilities_1.isArray)(t[namespaces_1.SOA.hasEnumerationMember])&&!t[namespaces_1.SOA.hasEnumerationMember].includes(s)&&(t[namespaces_1.SOA.hasEnumerationMember].push(s),(0,utilities_1.isArray)(e[namespaces_1.SOA.enumerationDomainIncludes])?e[namespaces_1.SOA.enumerationDomainIncludes].push(a):e[namespaces_1.SOA.enumerationDomainIncludes]=[a])}}return!0}catch(s){return this.sdoAdapter.onError(s),!1}})}addGraphNode(s,e,t){try{if(s[e["@id"]]){const a=s[e["@id"]];if((0,utilities_1.isNil)(e[namespaces_1.SCHEMA.isPartOf])||(a[namespaces_1.SCHEMA.isPartOf]=e[namespaces_1.SCHEMA.isPartOf]),(0,utilities_1.isNil)(e[namespaces_1.DC.source])||(a[namespaces_1.DC.source]=e[namespaces_1.DC.source]),(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.source])||(a[namespaces_1.SCHEMA.source]=e[namespaces_1.SCHEMA.source]),(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.category])||(a[namespaces_1.SCHEMA.category]=e[namespaces_1.SCHEMA.category]),(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.supersededBy])||(a[namespaces_1.SCHEMA.supersededBy]=e[namespaces_1.SCHEMA.supersededBy]),!(0,utilities_1.isNil)(e[namespaces_1.RDFS.label])){const s=Object.keys(e[namespaces_1.RDFS.label]);for(const t of s)a[namespaces_1.RDFS.label][t]=e[namespaces_1.RDFS.label][t]}if(!(0,utilities_1.isNil)(e[namespaces_1.RDFS.comment])){const s=Object.keys(e[namespaces_1.RDFS.comment]);for(const t of s)a[namespaces_1.RDFS.comment][t]=e[namespaces_1.RDFS.comment][t]}if(!(0,utilities_1.isNil)(e[namespaces_1.RDFS.subClassOf]))for(const s of e[namespaces_1.RDFS.subClassOf])a[namespaces_1.RDFS.subClassOf].includes(s)||a[namespaces_1.RDFS.subClassOf].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SOA.superClassOf]))for(const s of e[namespaces_1.SOA.superClassOf])a[namespaces_1.SOA.superClassOf].includes(s)||a[namespaces_1.SOA.superClassOf].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SOA.hasProperty]))for(const s of e[namespaces_1.SOA.hasProperty])a[namespaces_1.SOA.hasProperty].includes(s)||a[namespaces_1.SOA.hasProperty].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SOA.isRangeOf]))for(const s of e[namespaces_1.SOA.isRangeOf])a[namespaces_1.SOA.isRangeOf].includes(s)||a[namespaces_1.SOA.isRangeOf].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SOA.enumerationDomainIncludes]))for(const s of e[namespaces_1.SOA.enumerationDomainIncludes])a[namespaces_1.SOA.enumerationDomainIncludes].includes(s)||a[namespaces_1.SOA.enumerationDomainIncludes].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SOA.hasEnumerationMember]))for(const s of e[namespaces_1.SOA.hasEnumerationMember])a[namespaces_1.SOA.hasEnumerationMember].includes(s)||a[namespaces_1.SOA.hasEnumerationMember].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.RDFS.subPropertyOf]))for(const s of e[namespaces_1.RDFS.subPropertyOf])a[namespaces_1.RDFS.subPropertyOf].includes(s)||a[namespaces_1.RDFS.subPropertyOf].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.domainIncludes]))for(const s of e[namespaces_1.SCHEMA.domainIncludes])a[namespaces_1.SCHEMA.domainIncludes].includes(s)||a[namespaces_1.SCHEMA.domainIncludes].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.rangeIncludes]))for(const s of e[namespaces_1.SCHEMA.rangeIncludes])a[namespaces_1.SCHEMA.rangeIncludes].includes(s)||a[namespaces_1.SCHEMA.rangeIncludes].push(s);if(!(0,utilities_1.isNil)(e[namespaces_1.SOA.superPropertyOf]))for(const s of e[namespaces_1.SOA.superPropertyOf])a[namespaces_1.SOA.superPropertyOf].includes(s)||a[namespaces_1.SOA.superPropertyOf].push(s);t&&(a.vocabURLs?a.vocabURLs.includes(t)||a.vocabURLs.push(t):a.vocabURLs=[t])}else s[e["@id"]]=e,t&&(s[e["@id"]].vocabURLs=[t]);return!0}catch(s){return this.sdoAdapter.onError(s),!1}}getTerm(s,e){const t=this.discoverCompactIRI(s);if(!t)throw new Error("There is no term with the IRI "+s);let a,i,n=0;do{switch(n){case 0:a=this.classes[t],i="Class";break;case 1:a=this.properties[t],i="Property";break;case 2:a=this.dataTypes[t],i="DataType";break;case 3:a=this.enumerations[t],i="Enumeration";break;case 4:a=this.enumerationMembers[t],i="EnumerationMember"}n++}while(!a&&n<6);if(!a||!i)throw new Error("There is no term with the IRI "+s);if(0===(a=(0,reasoning_1.applyFilter)({data:[a["@id"]],filter:e,graph:this})).length)throw new Error("There is no term with that IRI and filter settings.");switch(i){case"Class":return new Class_1.Class(t,this);case"Property":return new Property_1.Property(t,this);case"Enumeration":return new Enumeration_1.Enumeration(t,this);case"EnumerationMember":return new EnumerationMember_1.EnumerationMember(t,this);case"DataType":return new DataType_1.DataType(t,this)}throw new Error("targetType with unknown value: "+i)}getClass(s,e){const t=this.discoverCompactIRI(s);if(t){let s=this.classes[t];if(s){if(0===(s=(0,reasoning_1.applyFilter)({data:[t],filter:e,graph:this})).length)throw new Error("There is no class with that IRI and filter settings.");return new Class_1.Class(t,this)}if(s=this.enumerations[t])try{return this.getEnumeration(t,e)}catch(s){throw new Error("There is no class with that IRI and filter settings.")}}throw new Error("There is no class with the IRI "+s)}getProperty(s,e){const t=this.discoverCompactIRI(s);if(t){let s=this.properties[t];if(s){if(0===(s=(0,reasoning_1.applyFilter)({data:[t],filter:e,graph:this})).length)throw new Error("There is no property with that URI and filter settings.");return new Property_1.Property(t,this)}}throw new Error("There is no property with that URI.")}getDataType(s,e){const t=this.discoverCompactIRI(s);if(t){let s=this.dataTypes[t];if(s){if(0===(s=(0,reasoning_1.applyFilter)({data:[t],filter:e,graph:this})).length)throw new Error("There is no data-type with that IRI and filter settings.");return new DataType_1.DataType(t,this)}}throw new Error("There is no data-type with the IRI "+s)}getEnumeration(s,e){const t=this.discoverCompactIRI(s);if(t){let s=this.enumerations[t];if(s){if(0===(s=(0,reasoning_1.applyFilter)({data:[t],filter:e,graph:this})).length)throw new Error("There is no enumeration with that IRI and filter settings.");return new Enumeration_1.Enumeration(t,this)}}throw new Error("There is no enumeration with the IRI "+s)}getEnumerationMember(s,e){const t=this.discoverCompactIRI(s);if(t){let s=this.enumerationMembers[t];if(s){if(0===(s=(0,reasoning_1.applyFilter)({data:[t],filter:e,graph:this})).length)throw new Error("There is no EnumerationMember with that IRI and filter settings.");return new EnumerationMember_1.EnumerationMember(t,this)}}throw new Error("There is no EnumerationMember with the IRI "+s)}discoverCompactIRI(s){if(s.includes(":")){const e=Object.keys(this.context);for(const t of e){const e=this.context[t];if((0,utilities_1.isString)(e)){if(s.startsWith(t))return s;if(s.startsWith(e)||this.sdoAdapter.equateVocabularyProtocols&&s.startsWith((0,utilities_1.switchIRIProtocol)(e)))try{return(0,utilities_1.toCompactIRI)(s,this.context,this.sdoAdapter.equateVocabularyProtocols)}catch(s){return null}}}}else{const e=Object.keys(this.classes);for(const t of e)if(this.containsLabel(this.classes[t],s))return t;const t=Object.keys(this.properties);for(const e of t)if(this.containsLabel(this.properties[e],s))return e;const a=Object.keys(this.dataTypes);for(const e of a)if(this.containsLabel(this.dataTypes[e],s))return e;const i=Object.keys(this.enumerations);for(const e of i)if(this.containsLabel(this.enumerations[e],s))return e;const n=Object.keys(this.enumerationMembers);for(const e of n)if(this.containsLabel(this.enumerationMembers[e],s))return e}return null}containsLabel(s,e){if(s&&(0,utilities_1.isObject)(s[namespaces_1.RDFS.label])){const t=Object.keys(s[namespaces_1.RDFS.label]);for(const a of t)if(s[namespaces_1.RDFS.label][a]===e)return!0}return!1}}exports.Graph=Graph;
...
"use strict";var __awaiter=this&&this.__awaiter||function(t,e,r,s){return new(r||(r=Promise))(function(i,a){function o(t){try{h(s.next(t))}catch(t){a(t)}}function n(t){try{h(s.throw(t))}catch(t){a(t)}}function h(t){var e;t.done?i(t.value):(e=t.value,e instanceof r?e:new r(function(t){t(e)})).then(o,n)}h((s=s.apply(t,e||[])).next())})},__importDefault=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.SDOAdapter=void 0;const Graph_1=_dereq_("./Graph"),axios_1=__importDefault(_dereq_("axios")),utilities_1=_dereq_("./utilities"),reasoning_1=_dereq_("./reasoning");class SDOAdapter{constructor(t){(null==t?void 0:t.commit)&&(this.commit=t.commit),"function"==typeof(null==t?void 0:t.onError)?this.onError=t.onError:this.onError=function(){},void 0!==(null==t?void 0:t.schemaHttps)?this.schemaHttps=t.schemaHttps:this.schemaHttps=!0,void 0!==(null==t?void 0:t.equateVocabularyProtocols)?this.equateVocabularyProtocols=t.equateVocabularyProtocols:this.equateVocabularyProtocols=!1,this.graph=new Graph_1.Graph(this)}addVocabularies(t){return __awaiter(this,void 0,void 0,function*(){t=(0,utilities_1.toArray)(t);for(const e of t)if((0,utilities_1.isString)(e))if(e.startsWith("www")||e.startsWith("http"))try{let t=yield this.fetchVocabularyFromURL(e);(0,utilities_1.isString)(t)&&(t=JSON.parse(t)),yield this.graph.addVocabulary(t,e)}catch(t){throw new Error("The given URL "+e+" did not contain a valid JSON-LD vocabulary.")}else try{yield this.graph.addVocabulary(JSON.parse(e))}catch(t){throw new Error("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!(0,utilities_1.isObject)(e))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");yield this.graph.addVocabulary(e)}return!0})}fetchVocabularyFromURL(t){return __awaiter(this,void 0,void 0,function*(){try{return(yield axios_1.default.get(t,{headers:{Accept:"application/ld+json, application/json"}})).data}catch(t){throw new Error("Could not find any resource at the given URL.")}})}getTerm(t,e){return this.graph.getTerm(t,e)}getAllTerms(t){const e=[],r=this.getListOfClasses(t),s=this.getListOfEnumerations(t),i=this.getListOfProperties(t),a=this.getListOfDataTypes(t),o=this.getListOfEnumerationMembers(t);for(const t of r)e.push(this.getClass(t));for(const t of s)e.push(this.getEnumeration(t));for(const t of i)e.push(this.getProperty(t));for(const t of a)e.push(this.getDataType(t));for(const t of o)e.push(this.getEnumerationMember(t));return e}getListOfTerms(t){const e=[];return e.push(...Object.keys(this.graph.classes)),e.push(...Object.keys(this.graph.enumerations)),e.push(...Object.keys(this.graph.properties)),e.push(...Object.keys(this.graph.dataTypes)),e.push(...Object.keys(this.graph.enumerationMembers)),(0,reasoning_1.applyFilter)({data:e,filter:t,graph:this.graph})}getClass(t,e){return this.graph.getClass(t,e)}getAllClasses(t){const e=[],r=this.getListOfClasses(t);for(const t of r)e.push(this.getClass(t));return e}getListOfClasses(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.classes),filter:t,graph:this.graph})}getProperty(t,e){return this.graph.getProperty(t,e)}getAllProperties(t){const e=[],r=this.getListOfProperties(t);for(const t of r)e.push(this.getProperty(t));return e}getListOfProperties(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.properties),filter:t,graph:this.graph})}getDataType(t,e){return this.graph.getDataType(t,e)}getAllDataTypes(t){const e=[],r=this.getListOfDataTypes(t);for(const t of r)e.push(this.getDataType(t));return e}getListOfDataTypes(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.dataTypes),filter:t,graph:this.graph})}getEnumeration(t,e){return this.graph.getEnumeration(t,e)}getAllEnumerations(t){const e=[],r=this.getListOfEnumerations(t);for(const t of r)e.push(this.getEnumeration(t));return e}getListOfEnumerations(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.enumerations),filter:t,graph:this.graph})}getEnumerationMember(t,e){return this.graph.getEnumerationMember(t,e)}getAllEnumerationMembers(t){const e=[],r=this.getListOfEnumerationMembers(t);for(const t of r)e.push(this.getEnumerationMember(t));return e}getListOfEnumerationMembers(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.enumerationMembers),filter:t,graph:this.graph})}getVocabularies(){const t=Object.keys(this.graph.context),e={},r=["soa","xsd","rdf","rdfa","rdfs","dc"];return t.forEach(t=>{(0,utilities_1.isString)(this.graph.context[t])&&!r.includes(t)&&(e[t]=this.graph.context[t])}),e}getLatestSchemaVersion(){return __awaiter(this,void 0,void 0,function*(){return yield(0,utilities_1.getLatestSchemaVersion)(this.commit)})}constructURLSchemaVocabulary(t="latest"){return __awaiter(this,void 0,void 0,function*(){return yield(0,utilities_1.constructURLSchemaVocabulary)(t,this.schemaHttps,this.commit)})}}exports.SDOAdapter=SDOAdapter;
