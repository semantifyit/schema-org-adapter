...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Class=void 0;const Term_1=_dereq_("./Term"),reasoning_1=_dereq_("./reasoning"),namespaces_1=_dereq_("./namespaces");class Class extends Term_1.Term{constructor(s,e){super(s,e),this.termTypeLabel=namespaces_1.TermTypeLabel.class,this.termTypeIRI=namespaces_1.TermTypeIRI.class}getTermObj(){return this.graph.classes[this.IRI]}getProperties(s=!0,e){const r=this.getTermObj(),t=[];return t.push(...r[namespaces_1.SOA.hasProperty]),s&&t.push(...(0,reasoning_1.inferPropertiesFromSuperClasses)(r[namespaces_1.RDFS.subClassOf],this.graph)),(0,reasoning_1.applyFilter)({data:t,filter:e,graph:this.graph})}getSuperClasses(s=!0,e){const r=this.getTermObj(),t=[];return s?t.push(...(0,reasoning_1.inferSuperClasses)(this.IRI,this.graph)):t.push(...r[namespaces_1.RDFS.subClassOf]),(0,reasoning_1.applyFilter)({data:t,filter:e,graph:this.graph})}getSubClasses(s=!0,e){const r=this.getTermObj(),t=[];return s?t.push(...(0,reasoning_1.inferSubClasses)(this.IRI,this.graph)):t.push(...r[namespaces_1.SOA.superClassOf]),(0,reasoning_1.applyFilter)({data:t,filter:e,graph:this.graph})}isRangeOf(s=!0,e){const r=[];return s?r.push(...(0,reasoning_1.inferRangeOf)(this.IRI,this.graph)):r.push(...this.getTermObj()[namespaces_1.SOA.isRangeOf]),(0,reasoning_1.applyFilter)({data:r,filter:e,graph:this.graph})}toString(s=!0,e){return JSON.stringify(this.toJSON(s,e),null,2)}toJSON(s=!0,e){const r=super.toJSON();return r.superClasses=this.getSuperClasses(s,e),r.subClasses=this.getSubClasses(s,e),r.properties=this.getProperties(s,e),r.rangeOf=this.isRangeOf(s,e),r}}exports.Class=Class;

},{"./Term":9,"./namespaces":12,"./reasoning":13}],2:[function(_dereq_,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.DataType=void 0;const Term_1=_dereq_("./Term"),reasoning_1=_dereq_("./reasoning"),namespaces_1=_dereq_("./namespaces");class DataType extends Term_1.Term{constructor(e,s){super(e,s),this.termTypeLabel=namespaces_1.TermTypeLabel.dataType,this.termTypeIRI=namespaces_1.TermTypeIRI.dataType}getTermObj(){return this.graph.dataTypes[this.IRI]}getSuperDataTypes(e=!0,s){const a=this.getTermObj(),t=[];return e?t.push(...(0,reasoning_1.inferSuperDataTypes)(this.IRI,this.graph)):t.push(...a[namespaces_1.RDFS.subClassOf]),(0,reasoning_1.applyFilter)({data:t,filter:s,graph:this.graph})}getSubDataTypes(e=!0,s){const a=this.getTermObj(),t=[];return e?t.push(...(0,reasoning_1.inferSubDataTypes)(this.IRI,this.graph)):t.push(...a[namespaces_1.SOA.superClassOf]),(0,reasoning_1.applyFilter)({data:t,filter:s,graph:this.graph})}isRangeOf(e=!0,s){const a=[];return e?a.push(...(0,reasoning_1.inferRangeOf)(this.IRI,this.graph)):a.push(...this.getTermObj()[namespaces_1.SOA.isRangeOf]),(0,reasoning_1.applyFilter)({data:a,filter:s,graph:this.graph})}toJSON(e=!0,s){const a=super.toJSON();return a.superDataTypes=this.getSuperDataTypes(e,s),a.subDataTypes=this.getSubDataTypes(e,s),a.rangeOf=this.isRangeOf(e,s),a}toString(e=!0,s){return JSON.stringify(this.toJSON(e,s),null,2)}}exports.DataType=DataType;

},{"./Term":9,"./namespaces":12,"./reasoning":13}],3:[function(_dereq_,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Enumeration=void 0;const Class_1=_dereq_("./Class"),utilities_1=_dereq_("./utilities"),namespaces_1=_dereq_("./namespaces"),reasoning_1=_dereq_("./reasoning");class Enumeration extends Class_1.Class{constructor(e,s){super(e,s),this.termTypeLabel=namespaces_1.TermTypeLabel.enumeration,this.termTypeIRI=namespaces_1.TermTypeIRI.enumeration}getTermObj(){return this.graph.enumerations[this.IRI]}getEnumerationMembers(e=!0,s){const t=[];if(t.push(...this.getTermObj()[namespaces_1.SOA.hasEnumerationMember]),e){const e=this.getSubClasses(!0);for(const s of e){const e=this.graph.enumerations[s];(0,utilities_1.isNil)(e)||t.push(...e[namespaces_1.SOA.hasEnumerationMember])}}return(0,reasoning_1.applyFilter)({data:t,filter:s,graph:this.graph})}toString(e=!0,s){return JSON.stringify(this.toJSON(e,s),null,2)}toJSON(e=!0,s){const t=super.toJSON(e,s);return t.enumerationMembers=this.getEnumerationMembers(e,s),t}}exports.Enumeration=Enumeration;

},{"./Class":1,"./namespaces":12,"./reasoning":13,"./utilities":14}],4:[function(_dereq_,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.EnumerationMember=void 0;const Term_1=_dereq_("./Term"),utilities_1=_dereq_("./utilities"),reasoning_1=_dereq_("./reasoning"),namespaces_1=_dereq_("./namespaces");class EnumerationMember extends Term_1.Term{constructor(e,r){super(e,r),this.termTypeLabel=namespaces_1.TermTypeLabel.enumerationMember,this.termTypeIRI=namespaces_1.TermTypeIRI.enumerationMember}getTermObj(){return this.graph.enumerationMembers[this.IRI]}getDomainEnumerations(e=!0,r){const t=this.getTermObj();let n=[];if(n.push(...t[namespaces_1.SOA.enumerationDomainIncludes]),e){const e=(0,utilities_1.cloneJson)(n);for(const r of e)n.push(...(0,reasoning_1.inferSuperClasses)(r,this.graph));n=(0,reasoning_1.applyFilter)({data:n,filter:{termType:namespaces_1.TermTypeLabel.enumeration},graph:this.graph})}return(0,reasoning_1.applyFilter)({data:n,filter:r,graph:this.graph})}toString(e=!0,r){return JSON.stringify(this.toJSON(e,r),null,2)}toJSON(e=!0,r){const t=super.toJSON();return t.domainEnumerations=this.getDomainEnumerations(e,r),t}}exports.EnumerationMember=EnumerationMember;

},{"./Term":9,"./namespaces":12,"./reasoning":13,"./utilities":14}],5:[function(_dereq_,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(e,s,t,a){return new(t||(t=Promise))(function(i,n){function r(e){try{c(a.next(e))}catch(e){n(e)}}function o(e){try{c(a.throw(e))}catch(e){n(e)}}function c(e){var s;e.done?i(e.value):(s=e.value,s instanceof t?s:new t(function(e){e(s)})).then(r,o)}c((a=a.apply(e,s||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Graph=void 0;const Class_1=_dereq_("./Class"),Property_1=_dereq_("./Property"),Enumeration_1=_dereq_("./Enumeration"),EnumerationMember_1=_dereq_("./EnumerationMember"),DataType_1=_dereq_("./DataType"),utilities_1=_dereq_("./utilities"),namespaces_1=_dereq_("./namespaces"),graphUtilities_1=_dereq_("./graphUtilities"),reasoning_1=_dereq_("./reasoning");class Graph{constructor(e){this.sdoAdapter=e,this.context=(0,graphUtilities_1.getStandardContext)(),this.classes={},this.properties={},this.dataTypes={},this.enumerations={},this.enumerationMembers={}}addVocabulary(e,s){return __awaiter(this,void 0,void 0,function*(){void 0===this.context.schema&&(this.context.schema=(0,graphUtilities_1.discoverUsedSchemaOrgProtocol)(e)+"://schema.org/");try{if(this.sdoAdapter.equateVocabularyProtocols){const s=(0,graphUtilities_1.discoverEquateNamespaces)(this.context,e);if(s.length>0){const t=(0,utilities_1.cloneJson)(e["@context"]);s.forEach(e=>{const s=Object.keys(t).find(s=>t[s]===e);s&&delete t[s];const a=Object.keys(this.context).find(s=>this.context[s]===(0,utilities_1.switchIRIProtocol)(e));t[a]=e}),e=yield(0,graphUtilities_1.preProcessVocab)(e,t),s.forEach(s=>{const t=Object.keys(this.context).find(e=>this.context[e]===(0,utilities_1.switchIRIProtocol)(s));e["@context"][t]=this.context[t]})}}this.context=(0,graphUtilities_1.generateContext)(this.context,e["@context"]),e=yield(0,graphUtilities_1.preProcessVocab)(e,this.context);const t=this.sdoAdapter.getVocabularies();for(let s of e["@graph"])s=(0,graphUtilities_1.curateVocabNode)(s,t);for(let t=0;t<e["@graph"].length;t++){const a=(0,utilities_1.cloneJson)(e["@graph"][t]);if((0,utilities_1.isString)(a["@type"]))switch(a["@type"]){case namespaces_1.TermTypeIRI.class:this.addGraphNode(this.classes,a,s);break;case namespaces_1.TermTypeIRI.property:this.addGraphNode(this.properties,a,s);break;default:this.addGraphNode(this.enumerationMembers,a,s)}else(0,utilities_1.isArray)(a["@type"])?a["@type"].includes(namespaces_1.TermTypeIRI.class)&&a["@type"].includes(namespaces_1.TermTypeIRI.dataType)?this.addGraphNode(this.dataTypes,a,s):this.addGraphNode(this.enumerationMembers,a,s):this.sdoAdapter.onError("unexpected @type format for the following node: "+JSON.stringify(a,null,2))}let a,i;do{a=!1;const e=Object.keys(this.classes),s=Object.keys(this.enumerations);for(const t of e)if(void 0!==this.classes[t][namespaces_1.RDFS.subClassOf]){const e=this.classes[t][namespaces_1.RDFS.subClassOf];for(const i of e)(i===namespaces_1.TermTypeIRI.enumeration||s.includes(i))&&this.classes[t]&&!this.enumerations[t]&&(a=!0,this.enumerations[t]=(0,utilities_1.cloneJson)(this.classes[t]),delete this.classes[t])}}while(a);do{i=!1;const e=Object.keys(this.classes),s=Object.keys(this.dataTypes);for(const t of e)if(void 0!==this.classes[t][namespaces_1.RDFS.subClassOf]){const e=this.classes[t][namespaces_1.RDFS.subClassOf];for(const a of e)(a===namespaces_1.TermTypeIRI.dataType||s.includes(a))&&this.classes[t]&&!this.dataTypes[t]&&(i=!0,this.dataTypes[t]=(0,utilities_1.cloneJson)(this.classes[t]),delete this.classes[t])}}while(i);const n=Object.keys(this.dataTypes);for(const e of n)this.dataTypes[e]["@type"]=namespaces_1.TermTypeIRI.dataType;let r=Object.keys(this.classes);for(const e of r){const s=this.classes[e][namespaces_1.RDFS.subClassOf];this.classes[e][namespaces_1.SOA.superClassOf]||(this.classes[e][namespaces_1.SOA.superClassOf]=[]);for(const t of s){let s=this.classes[t];s||(s=this.enumerations[t]),s&&(s[namespaces_1.SOA.superClassOf]?s[namespaces_1.SOA.superClassOf].includes(e)||s[namespaces_1.SOA.superClassOf].push(e):s[namespaces_1.SOA.superClassOf]=[e])}}let o=Object.keys(this.enumerations);for(const e of o){const s=this.enumerations[e][namespaces_1.RDFS.subClassOf];this.enumerations[e][namespaces_1.SOA.superClassOf]||(this.enumerations[e][namespaces_1.SOA.superClassOf]=[]);for(const t of s){let s=this.classes[t];s||(s=this.enumerations[t]),s&&(s[namespaces_1.SOA.superClassOf]?s[namespaces_1.SOA.superClassOf].includes(e)||s[namespaces_1.SOA.superClassOf].push(e):s[namespaces_1.SOA.superClassOf]=[e])}}let c=Object.keys(this.dataTypes);for(const e of c){const s=this.dataTypes[e][namespaces_1.RDFS.subClassOf];if(this.dataTypes[e][namespaces_1.SOA.superClassOf]||(this.dataTypes[e][namespaces_1.SOA.superClassOf]=[]),s)for(const t of s){const s=this.dataTypes[t];s&&(s[namespaces_1.SOA.superClassOf]?s[namespaces_1.SOA.superClassOf].includes(e)||s[namespaces_1.SOA.superClassOf].push(e):s[namespaces_1.SOA.superClassOf]=[e])}else this.dataTypes[e][namespaces_1.RDFS.subClassOf]=[]}let p=Object.keys(this.properties);for(const e of p){const s=this.properties[e][namespaces_1.RDFS.subPropertyOf];if(this.properties[e][namespaces_1.SOA.superPropertyOf]||(this.properties[e][namespaces_1.SOA.superPropertyOf]=[]),s)for(const t of s){const s=this.properties[t];s&&(s[namespaces_1.SOA.superPropertyOf]?s[namespaces_1.SOA.superPropertyOf].includes(e)||s[namespaces_1.SOA.superPropertyOf].push(e):s[namespaces_1.SOA.superPropertyOf]=[e])}else this.properties[e][namespaces_1.RDFS.subPropertyOf]=[]}r=Object.keys(this.classes);for(const e of r)this.classes[e][namespaces_1.SOA.hasProperty]||(this.classes[e][namespaces_1.SOA.hasProperty]=[]),this.classes[e][namespaces_1.SOA.isRangeOf]||(this.classes[e][namespaces_1.SOA.isRangeOf]=[]);o=Object.keys(this.enumerations);for(const e of o)this.enumerations[e][namespaces_1.SOA.hasEnumerationMember]||(this.enumerations[e][namespaces_1.SOA.hasEnumerationMember]=[]),this.enumerations[e][namespaces_1.SOA.isRangeOf]||(this.enumerations[e][namespaces_1.SOA.isRangeOf]=[]),this.enumerations[e][namespaces_1.SOA.hasProperty]||(this.enumerations[e][namespaces_1.SOA.hasProperty]=[]);c=Object.keys(this.dataTypes);for(const e of c)this.dataTypes[e][namespaces_1.SOA.isRangeOf]||(this.dataTypes[e][namespaces_1.SOA.isRangeOf]=[]);let h=Object.keys(this.enumerationMembers);for(const e of h)this.enumerationMembers[e][namespaces_1.SOA.enumerationDomainIncludes]||(this.enumerationMembers[e][namespaces_1.SOA.enumerationDomainIncludes]=[]);p=Object.keys(this.properties);for(const e of p){const s=this.properties[e][namespaces_1.SCHEMA.domainIncludes];if((0,utilities_1.isArray)(s))for(const t of s){let s=this.classes[t];s||(s=this.enumerations[t]),s&&(0,utilities_1.isArray)(s[namespaces_1.SOA.hasProperty])&&!s[namespaces_1.SOA.hasProperty].includes(e)&&s[namespaces_1.SOA.hasProperty].push(e)}const t=this.properties[e][namespaces_1.SCHEMA.rangeIncludes];if((0,utilities_1.isArray)(t))for(const s of t){const t=this.classes[s]||this.enumerations[s]||this.dataTypes[s];t&&(0,utilities_1.isArray)(t[namespaces_1.SOA.isRangeOf])&&!t[namespaces_1.SOA.isRangeOf].includes(e)&&t[namespaces_1.SOA.isRangeOf].push(e)}}h=Object.keys(this.enumerationMembers);for(const e of h){const s=this.enumerationMembers[e];let t=s["@type"];(0,utilities_1.isArray)(t)||(t=[t]);for(const a of t){const t=this.enumerations[a];t&&(0,utilities_1.isArray)(t[namespaces_1.SOA.hasEnumerationMember])&&!t[namespaces_1.SOA.hasEnumerationMember].includes(e)&&(t[namespaces_1.SOA.hasEnumerationMember].push(e),(0,utilities_1.isArray)(s[namespaces_1.SOA.enumerationDomainIncludes])?s[namespaces_1.SOA.enumerationDomainIncludes].push(a):s[namespaces_1.SOA.enumerationDomainIncludes]=[a])}}return!0}catch(e){return this.sdoAdapter.onError(e),!1}})}addGraphNode(e,s,t){try{if(e[s["@id"]]){const a=e[s["@id"]];if((0,utilities_1.isNil)(s[namespaces_1.SCHEMA.isPartOf])||(a[namespaces_1.SCHEMA.isPartOf]=s[namespaces_1.SCHEMA.isPartOf]),(0,utilities_1.isNil)(s[namespaces_1.DC.source])||(a[namespaces_1.DC.source]=s[namespaces_1.DC.source]),(0,utilities_1.isNil)(s[namespaces_1.SCHEMA.source])||(a[namespaces_1.SCHEMA.source]=s[namespaces_1.SCHEMA.source]),(0,utilities_1.isNil)(s[namespaces_1.SCHEMA.category])||(a[namespaces_1.SCHEMA.category]=s[namespaces_1.SCHEMA.category]),(0,utilities_1.isNil)(s[namespaces_1.SCHEMA.supersededBy])||(a[namespaces_1.SCHEMA.supersededBy]=s[namespaces_1.SCHEMA.supersededBy]),!(0,utilities_1.isNil)(s[namespaces_1.RDFS.label])){const e=Object.keys(s[namespaces_1.RDFS.label]);for(const t of e)a[namespaces_1.RDFS.label][t]=s[namespaces_1.RDFS.label][t]}if(!(0,utilities_1.isNil)(s[namespaces_1.RDFS.comment])){const e=Object.keys(s[namespaces_1.RDFS.comment]);for(const t of e)a[namespaces_1.RDFS.comment][t]=s[namespaces_1.RDFS.comment][t]}if(!(0,utilities_1.isNil)(s[namespaces_1.RDFS.subClassOf]))for(const e of s[namespaces_1.RDFS.subClassOf])a[namespaces_1.RDFS.subClassOf].includes(e)||a[namespaces_1.RDFS.subClassOf].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SOA.superClassOf]))for(const e of s[namespaces_1.SOA.superClassOf])a[namespaces_1.SOA.superClassOf].includes(e)||a[namespaces_1.SOA.superClassOf].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SOA.hasProperty]))for(const e of s[namespaces_1.SOA.hasProperty])a[namespaces_1.SOA.hasProperty].includes(e)||a[namespaces_1.SOA.hasProperty].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SOA.isRangeOf]))for(const e of s[namespaces_1.SOA.isRangeOf])a[namespaces_1.SOA.isRangeOf].includes(e)||a[namespaces_1.SOA.isRangeOf].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SOA.enumerationDomainIncludes]))for(const e of s[namespaces_1.SOA.enumerationDomainIncludes])a[namespaces_1.SOA.enumerationDomainIncludes].includes(e)||a[namespaces_1.SOA.enumerationDomainIncludes].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SOA.hasEnumerationMember]))for(const e of s[namespaces_1.SOA.hasEnumerationMember])a[namespaces_1.SOA.hasEnumerationMember].includes(e)||a[namespaces_1.SOA.hasEnumerationMember].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.RDFS.subPropertyOf]))for(const e of s[namespaces_1.RDFS.subPropertyOf])a[namespaces_1.RDFS.subPropertyOf].includes(e)||a[namespaces_1.RDFS.subPropertyOf].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SCHEMA.domainIncludes]))for(const e of s[namespaces_1.SCHEMA.domainIncludes])a[namespaces_1.SCHEMA.domainIncludes].includes(e)||a[namespaces_1.SCHEMA.domainIncludes].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SCHEMA.rangeIncludes]))for(const e of s[namespaces_1.SCHEMA.rangeIncludes])a[namespaces_1.SCHEMA.rangeIncludes].includes(e)||a[namespaces_1.SCHEMA.rangeIncludes].push(e);if(!(0,utilities_1.isNil)(s[namespaces_1.SOA.superPropertyOf]))for(const e of s[namespaces_1.SOA.superPropertyOf])a[namespaces_1.SOA.superPropertyOf].includes(e)||a[namespaces_1.SOA.superPropertyOf].push(e);t&&(a.vocabURLs?a.vocabURLs.includes(t)||a.vocabURLs.push(t):a.vocabURLs=[t])}else e[s["@id"]]=s,t&&(e[s["@id"]].vocabURLs=[t]);return!0}catch(e){return this.sdoAdapter.onError(e),!1}}getTerm(e,s){const t=this.discoverCompactIRI(e);if(!t)throw new Error("There is no term with the IRI "+e);let a,i,n=0;do{switch(n){case 0:a=this.classes[t],i="Class";break;case 1:a=this.properties[t],i="Property";break;case 2:a=this.dataTypes[t],i="DataType";break;case 3:a=this.enumerations[t],i="Enumeration";break;case 4:a=this.enumerationMembers[t],i="EnumerationMember"}n++}while(!a&&n<6);if(!a||!i)throw new Error("There is no term with the IRI "+e);if(0===(a=(0,reasoning_1.applyFilter)({data:[a["@id"]],filter:s,graph:this})).length)throw new Error("There is no term with that IRI and filter settings.");switch(i){case"Class":return new Class_1.Class(t,this);case"Property":return new Property_1.Property(t,this);case"Enumeration":return new Enumeration_1.Enumeration(t,this);case"EnumerationMember":return new EnumerationMember_1.EnumerationMember(t,this);case"DataType":return new DataType_1.DataType(t,this)}throw new Error("targetType with unknown value: "+i)}getClass(e,s){const t=this.discoverCompactIRI(e);if(t){let e=this.classes[t];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[t],filter:s,graph:this})).length)throw new Error("There is no class with that IRI and filter settings.");return new Class_1.Class(t,this)}if(e=this.enumerations[t])try{return this.getEnumeration(t,s)}catch(e){throw new Error("There is no class with that IRI and filter settings.")}}throw new Error("There is no class with the IRI "+e)}getProperty(e,s){const t=this.discoverCompactIRI(e);if(t){let e=this.properties[t];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[t],filter:s,graph:this})).length)throw new Error("There is no property with that URI and filter settings.");return new Property_1.Property(t,this)}}throw new Error("There is no property with that URI.")}getDataType(e,s){const t=this.discoverCompactIRI(e);if(t){let e=this.dataTypes[t];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[t],filter:s,graph:this})).length)throw new Error("There is no data-type with that IRI and filter settings.");return new DataType_1.DataType(t,this)}}throw new Error("There is no data-type with the IRI "+e)}getEnumeration(e,s){const t=this.discoverCompactIRI(e);if(t){let e=this.enumerations[t];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[t],filter:s,graph:this})).length)throw new Error("There is no enumeration with that IRI and filter settings.");return new Enumeration_1.Enumeration(t,this)}}throw new Error("There is no enumeration with the IRI "+e)}getEnumerationMember(e,s){const t=this.discoverCompactIRI(e);if(t){let e=this.enumerationMembers[t];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[t],filter:s,graph:this})).length)throw new Error("There is no EnumerationMember with that IRI and filter settings.");return new EnumerationMember_1.EnumerationMember(t,this)}}throw new Error("There is no EnumerationMember with the IRI "+e)}discoverCompactIRI(e){if(e.includes(":")){const s=Object.keys(this.context);for(const t of s){const s=this.context[t];if((0,utilities_1.isString)(s)){if(e.startsWith(t))return e;if(e.startsWith(s)||this.sdoAdapter.equateVocabularyProtocols&&e.startsWith((0,utilities_1.switchIRIProtocol)(s)))return(0,utilities_1.toCompactIRI)(e,this.context,this.sdoAdapter.equateVocabularyProtocols)}}}else{const s=Object.keys(this.classes);for(const t of s)if(this.containsLabel(this.classes[t],e))return t;const t=Object.keys(this.properties);for(const s of t)if(this.containsLabel(this.properties[s],e))return s;const a=Object.keys(this.dataTypes);for(const s of a)if(this.containsLabel(this.dataTypes[s],e))return s;const i=Object.keys(this.enumerations);for(const s of i)if(this.containsLabel(this.enumerations[s],e))return s;const n=Object.keys(this.enumerationMembers);for(const s of n)if(this.containsLabel(this.enumerationMembers[s],e))return s}return null}containsLabel(e,s){if(e&&(0,utilities_1.isObject)(e[namespaces_1.RDFS.label])){const t=Object.keys(e[namespaces_1.RDFS.label]);for(const a of t)if(e[namespaces_1.RDFS.label][a]===s)return!0}return!1}}exports.Graph=Graph;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Property=void 0;const Term_1=_dereq_("./Term"),reasoning_1=_dereq_("./reasoning"),namespaces_1=_dereq_("./namespaces");class Property extends Term_1.Term{constructor(e,r){super(e,r),this.termTypeLabel=namespaces_1.TermTypeLabel.property,this.termTypeIRI=namespaces_1.TermTypeIRI.property}getTermObj(){return this.graph.properties[this.IRI]}getRanges(e=!0,r){const s=this.getTermObj(),t=[];if(t.push(...s[namespaces_1.SCHEMA.rangeIncludes]),e){for(const e of t)t.push(...(0,reasoning_1.inferSubDataTypes)(e,this.graph));for(const e of t)t.push(...(0,reasoning_1.inferSubClasses)(e,this.graph))}return(0,reasoning_1.applyFilter)({data:t,filter:r,graph:this.graph})}getDomains(e=!0,r){const s=this.getTermObj(),t=[];if(t.push(...s[namespaces_1.SCHEMA.domainIncludes]),e){const e=[];for(const r of t)e.push(...(0,reasoning_1.inferSubClasses)(r,this.graph));t.push(...e)}return(0,reasoning_1.applyFilter)({data:t,filter:r,graph:this.graph})}getSuperProperties(e=!0,r){const s=this.getTermObj(),t=[];return e?t.push(...(0,reasoning_1.inferSuperProperties)(this.IRI,this.graph)):t.push(...s[namespaces_1.RDFS.subPropertyOf]),(0,reasoning_1.applyFilter)({data:t,filter:r,graph:this.graph})}getSubProperties(e=!0,r){const s=this.getTermObj(),t=[];return e?t.push(...(0,reasoning_1.inferSubProperties)(this.IRI,this.graph)):t.push(...s[namespaces_1.SOA.superPropertyOf]),(0,reasoning_1.applyFilter)({data:t,filter:r,graph:this.graph})}getInverseOf(){return this.getTermObj()[namespaces_1.SCHEMA.inverseOf]}toString(e=!0,r){return JSON.stringify(this.toJSON(e,r),null,2)}toJSON(e=!0,r){const s=super.toJSON();return s.ranges=this.getRanges(e,r),s.domains=this.getDomains(e,r),s.superProperties=this.getSuperProperties(e,r),s.subProperties=this.getSubProperties(e,r),s.inverseOf=this.getInverseOf(),s}}exports.Property=Property;

},{"./Term":9,"./namespaces":12,"./reasoning":13}],7:[function(_dereq_,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.RetrievalMemory=void 0;const utilities_1=_dereq_("./utilities");class RetrievalMemory{constructor(){this.cache=new Map}static getInstance(){return RetrievalMemory.instance||(RetrievalMemory.instance=new RetrievalMemory),RetrievalMemory.instance}setData(e,t,i="standard"){let r=this.cache.get(i);r||(r={},this.cache.set(i,r)),r[e]=(0,utilities_1.cloneJson)(t)}getData(e,t="standard"){const i=this.cache.get(t);if(i)return(0,utilities_1.cloneJson)(i[e])}deleteCache(){this.cache=new Map}}exports.RetrievalMemory=RetrievalMemory;

},{"./utilities":14}],8:[function(_dereq_,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(t,e,r,i){return new(r||(r=Promise))(function(s,a){function o(t){try{h(i.next(t))}catch(t){a(t)}}function n(t){try{h(i.throw(t))}catch(t){a(t)}}function h(t){var e;t.done?s(t.value):(e=t.value,e instanceof r?e:new r(function(t){t(e)})).then(o,n)}h((i=i.apply(t,e||[])).next())})},__importDefault=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.SDOAdapter=void 0;const Graph_1=_dereq_("./Graph"),axios_1=__importDefault(_dereq_("axios")),utilities_1=_dereq_("./utilities"),reasoning_1=_dereq_("./reasoning");class SDOAdapter{constructor(t){t&&t.commit&&(this.commit=t.commit),t&&"function"==typeof t.onError?this.onError=t.onError:this.onError=function(){},t&&void 0!==t.schemaHttps?this.schemaHttps=t.schemaHttps:this.schemaHttps=!0,t&&void 0!==t.equateVocabularyProtocols?this.equateVocabularyProtocols=t.equateVocabularyProtocols:this.equateVocabularyProtocols=!1,this.graph=new Graph_1.Graph(this)}addVocabularies(t){return __awaiter(this,void 0,void 0,function*(){if((0,utilities_1.isArray)(t)||(t=(0,utilities_1.toArray)(t)),!(0,utilities_1.isArray)(t))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");for(const e of t)if((0,utilities_1.isString)(e))if(e.startsWith("www")||e.startsWith("http"))try{let t=yield this.fetchVocabularyFromURL(e);(0,utilities_1.isString)(t)&&(t=JSON.parse(t)),yield this.graph.addVocabulary(t,e)}catch(t){throw console.log(t),new Error("The given URL "+e+" did not contain a valid JSON-LD vocabulary.")}else try{yield this.graph.addVocabulary(JSON.parse(e))}catch(t){throw new Error("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!(0,utilities_1.isObject)(e))throw new Error("The first argument of the function must be an Array of vocabularies or a single vocabulary (JSON-LD as Object/String)");yield this.graph.addVocabulary(e)}return!0})}fetchVocabularyFromURL(t){return __awaiter(this,void 0,void 0,function*(){return new Promise(function(e,r){axios_1.default.get(t,{headers:{Accept:"application/ld+json, application/json"}}).then(function(t){e(t.data)}).catch(function(){r("Could not find any resource at the given URL.")})})})}getTerm(t,e){return this.graph.getTerm(t,e)}getAllTerms(t){const e=[],r=this.getListOfClasses(t),i=this.getListOfEnumerations(t),s=this.getListOfProperties(t),a=this.getListOfDataTypes(t),o=this.getListOfEnumerationMembers(t);for(const t of r)try{e.push(this.getClass(t))}catch(e){throw new Error("There is no class with the IRI "+t)}for(const t of i)try{e.push(this.getEnumeration(t))}catch(e){throw new Error("There is no enumeration with the IRI "+t)}for(const t of s)try{e.push(this.getProperty(t))}catch(e){throw new Error("There is no property with the IRI "+t)}for(const t of a)try{e.push(this.getDataType(t))}catch(e){throw new Error("There is no data type with the IRI "+t)}for(const t of o)try{e.push(this.getEnumerationMember(t))}catch(e){throw new Error("There is no enumeration member with the IRI "+t)}return e}getListOfTerms(t){const e=[];return e.push(...Object.keys(this.graph.classes)),e.push(...Object.keys(this.graph.enumerations)),e.push(...Object.keys(this.graph.properties)),e.push(...Object.keys(this.graph.dataTypes)),e.push(...Object.keys(this.graph.enumerationMembers)),(0,reasoning_1.applyFilter)({data:e,filter:t,graph:this.graph})}getClass(t,e){return this.graph.getClass(t,e)}getAllClasses(t){const e=[],r=this.getListOfClasses(t);for(const t of r)try{e.push(this.getClass(t))}catch(e){throw new Error("There is no class with the IRI "+t)}return e}getListOfClasses(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.classes),filter:t,graph:this.graph})}getProperty(t,e){return this.graph.getProperty(t,e)}getAllProperties(t){const e=[],r=this.getListOfProperties(t);for(const t of r)try{e.push(this.getProperty(t))}catch(e){throw new Error("There is no property with the IRI "+t)}return e}getListOfProperties(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.properties),filter:t,graph:this.graph})}getDataType(t,e){return this.graph.getDataType(t,e)}getAllDataTypes(t){const e=[],r=this.getListOfDataTypes(t);for(const t of r)try{e.push(this.getDataType(t))}catch(e){throw new Error("There is no data type with the IRI "+t)}return e}getListOfDataTypes(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.dataTypes),filter:t,graph:this.graph})}getEnumeration(t,e){return this.graph.getEnumeration(t,e)}getAllEnumerations(t){const e=[],r=this.getListOfEnumerations(t);for(const t of r)try{e.push(this.getEnumeration(t))}catch(e){throw new Error("There is no enumeration with the IRI "+t)}return e}getListOfEnumerations(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.enumerations),filter:t,graph:this.graph})}getEnumerationMember(t,e){return this.graph.getEnumerationMember(t,e)}getAllEnumerationMembers(t){const e=[],r=this.getListOfEnumerationMembers(t);for(const t of r)try{e.push(this.getEnumerationMember(t))}catch(e){throw new Error("There is no enumeration member with the IRI "+t)}return e}getListOfEnumerationMembers(t){return(0,reasoning_1.applyFilter)({data:Object.keys(this.graph.enumerationMembers),filter:t,graph:this.graph})}getVocabularies(){const t=Object.keys(this.graph.context),e={},r=["soa","xsd","rdf","rdfa","rdfs","dc"];return t.map(t=>{(0,utilities_1.isString)(this.graph.context[t])&&!r.includes(t)&&(e[t]=this.graph.context[t])}),e}getLatestSchemaVersion(){return __awaiter(this,void 0,void 0,function*(){return yield(0,utilities_1.getLatestSchemaVersion)(this.commit)})}constructURLSchemaVocabulary(t="latest"){return __awaiter(this,void 0,void 0,function*(){return yield(0,utilities_1.constructURLSchemaVocabulary)(t,this.schemaHttps,this.commit)})}}exports.SDOAdapter=SDOAdapter;

},{"./Graph":5,"./reasoning":13,"./utilities":14,"axios":15}],9:[function(_dereq_,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Term=void 0;const utilities_1=_dereq_("./utilities"),namespaces_1=_dereq_("./namespaces");class Term{constructor(e,t){this.IRI=e,this.graph=t}getIRI(e=!1){return e?this.IRI:(0,utilities_1.toAbsoluteIRI)(this.IRI,this.graph.context)}getTermTypeLabel(){return this.termTypeLabel}getTermTypeIRI(){return this.termTypeIRI}getVocabURLs(){const e=this.getTermObj();return(0,utilities_1.isNil)(e.vocabURLs)?null:e.vocabURLs}getVocabulary(){const e=this.getTermObj();return(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.isPartOf])?null:e[namespaces_1.SCHEMA.isPartOf]}getSource(){const e=this.getTermObj();return(0,utilities_1.isNil)(e[namespaces_1.DC.source])?(0,utilities_1.isNil)(e[namespaces_1.SCHEMA.source])?null:e[namespaces_1.SCHEMA.source]:e[namespaces_1.DC.source]}isSupersededBy(){const e=this.getTermObj();return(0,utilities_1.isString)(e[namespaces_1.SCHEMA.supersededBy])?e[namespaces_1.SCHEMA.supersededBy]:null}getName(e="en"){const t=this.getTermObj()[namespaces_1.RDFS.label];return(0,utilities_1.isNil)(t)||(0,utilities_1.isNil)(t[e])?null:t[e]}getDescription(e="en"){const t=this.getTermObj()[namespaces_1.RDFS.comment];return(0,utilities_1.isNil)(t)||(0,utilities_1.isNil)(t[e])?null:t[e]}toString(){return JSON.stringify(this.toJSON(),null,2)}toJSON(){return{id:this.getIRI(!0),IRI:this.getIRI(),typeLabel:this.getTermTypeLabel(),typeIRI:this.getTermTypeIRI(),vocabURLs:this.getVocabURLs(),vocabulary:this.getVocabulary(),source:this.getSource(),supersededBy:this.isSupersededBy(),name:this.getName(),description:this.getDescription()}}}exports.Term=Term;

},{"./namespaces":12,"./utilities":14}],10:[function(_dereq_,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(e,s,t,a){return new(t||(t=Promise))(function(r,c){function i(e){try{o(a.next(e))}catch(e){c(e)}}function n(e){try{o(a.throw(e))}catch(e){c(e)}}function o(e){var s;e.done?r(e.value):(s=e.value,s instanceof t?s:new t(function(e){e(s)})).then(i,n)}o((a=a.apply(e,s||[])).next())})},__importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.getStandardContext=exports.checkIfNamespaceFromListIsUsed=exports.discoverEquateNamespaces=exports.discoverUsedSchemaOrgProtocol=exports.preProcessVocab=exports.generateContext=exports.curateVocabNode=void 0;const namespaces_1=_dereq_("./namespaces"),utilities_1=_dereq_("./utilities"),jsonld_1=__importDefault(_dereq_("jsonld"));function curateLanguageTerm(e,s){if(void 0!==e[s]){if((0,utilities_1.isString)(e[s]))e[s]={en:e[s]};else if((0,utilities_1.isLanguageObjectVocab)(e[s]))e[s]={[e[s]["@language"]]:e[s]["@value"]};else if((0,utilities_1.isArray)(e[s])){const t={};e[s].map(e=>{(0,utilities_1.isLanguageObjectVocab)(e)&&(t[e["@language"]]=e["@value"])}),e[s]=t}}else e[s]={}}function curateRelationshipTermArray(e,s,t){(0,utilities_1.isString)(e[s])?e[s]=[e[s]]:void 0===e[s]&&e["@type"]===t&&(e[s]=[])}function curateVocabNode(e,s){if(curateLanguageTerm(e,namespaces_1.RDFS.comment),curateLanguageTerm(e,namespaces_1.RDFS.label),curateRelationshipTermArray(e,namespaces_1.RDFS.subClassOf,namespaces_1.TermTypeIRI.class),curateRelationshipTermArray(e,namespaces_1.RDFS.subPropertyOf,namespaces_1.TermTypeIRI.property),curateRelationshipTermArray(e,namespaces_1.SCHEMA.domainIncludes,namespaces_1.TermTypeIRI.property),curateRelationshipTermArray(e,namespaces_1.SCHEMA.rangeIncludes,namespaces_1.TermTypeIRI.property),void 0===e[namespaces_1.SCHEMA.inverseOf]&&e["@type"]===namespaces_1.TermTypeIRI.property&&(e[namespaces_1.SCHEMA.inverseOf]=null),!(0,utilities_1.isString)(e[namespaces_1.SCHEMA.isPartOf])){let t=Object.keys(s).find(s=>e["@id"].substring(0,e["@id"].indexOf(":"))===s);if((0,utilities_1.isString)(t)){let a;t=s[t];do{a=!1,(t.endsWith("/")||t.endsWith("#"))&&(t=t.substring(0,t.length-1),a=!0)}while(a);e[namespaces_1.SCHEMA.isPartOf]=t}}return e}function generateContext(e,s){const t=Object.keys(e),a=Object.keys(s);let r=(0,utilities_1.cloneJson)(e);for(const e of a)if((0,utilities_1.isString)(s[e])){let a=!1;for(const c of t)if((0,utilities_1.isString)(r[c])&&r[c]===s[e]){a=!0;break}if(a)continue;if(r[e]){if(r[e]!==s[e]){let t=!1,a=1;for(;!t;){const c=e+a++;r[c]||(t=!0,r[c]=s[e])}}}else r[e]=s[e]}const c={};Object.keys(r).sort().forEach(function(e){c[e]=r[e]}),r=c;const i=Object.keys(r),n={};for(const e of i)(0,utilities_1.isString)(r[e])&&(n[e]=r[e]);for(const e of i)(0,utilities_1.isObject)(r[e])&&(n[e]=r[e]);return n}function preProcessVocab(e,s){return __awaiter(this,void 0,void 0,function*(){let t=!1;do{const s=[];t=!1;for(let a=0;a<e["@graph"].length;a++)void 0!==e["@graph"][a]["@graph"]?(s.push(...(0,utilities_1.cloneJson)(e["@graph"][a]["@graph"])),t=!0):s.push((0,utilities_1.cloneJson)(e["@graph"][a]));e["@graph"]=(0,utilities_1.cloneJson)(s)}while(t);const a=yield jsonld_1.default.compact(e,s);return void 0===a["@graph"]?(delete a["@context"],{"@context":s,"@graph":[a]}):a})}function discoverUsedSchemaOrgProtocol(e){const s="https://schema.org/",t="http://schema.org/";if(e["@context"])for(const a of Object.values(e["@context"]))if((0,utilities_1.isObject)(a)&&a["@vocab"]){if(a["@vocab"]===s)return"https";if(a["@vocab"]===t)return"http"}else if((0,utilities_1.isString)(a)){if(a===s)return"https";if(a===t)return"http"}const a=JSON.stringify(e),r=a.split(s).length-1,c=a.split(t).length-1;return r>c?"https":c>r?"http":s}function discoverEquateNamespaces(e,s){const t=new Set,a=[];return Object.values(e).forEach(function(e){(0,utilities_1.isString)(e)&&a.push((0,utilities_1.switchIRIProtocol)(e))}),s["@context"]&&Object.values(s["@context"]).forEach(function(e){(0,utilities_1.isString)(e)&&a.includes(e)&&t.add(e)}),Array.isArray(s["@graph"])&&s["@graph"].forEach(function(e){checkIfNamespaceFromListIsUsed(e["@id"],a,t),checkIfNamespaceFromListIsUsed(e["@type"],a,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.RDFS.subClassOf],a,t),checkIfNamespaceFromListIsUsed(e["http://www.w3.org/2000/01/rdf-schema#subClassOf"],a,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.SCHEMA.domainIncludes],a,t),checkIfNamespaceFromListIsUsed(e["http://schema.org/domainIncludes"],a,t),checkIfNamespaceFromListIsUsed(e["https://schema.org/domainIncludes"],a,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.SCHEMA.rangeIncludes],a,t),checkIfNamespaceFromListIsUsed(e["http://schema.org/rangeIncludes"],a,t),checkIfNamespaceFromListIsUsed(e["https://schema.org/rangeIncludes"],a,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.RDFS.subPropertyOf],a,t),checkIfNamespaceFromListIsUsed(e["http://www.w3.org/2000/01/rdf-schema#subPropertyOf"],a,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.SCHEMA.inverseOf],a,t),checkIfNamespaceFromListIsUsed(e["http://schema.org/inverseOf"],a,t),checkIfNamespaceFromListIsUsed(e["https://schema.org/inverseOf"],a,t)}),Array.from(t)}function checkIfNamespaceFromListIsUsed(e,s,t){if(Array.isArray(e))e.forEach(function(e){checkIfNamespaceFromListIsUsed(e,s,t)});else{let a;if(a=(0,utilities_1.isObject)(e)&&(0,utilities_1.isString)(e["@id"])?e["@id"]:e,(0,utilities_1.isString)(a)&&a.startsWith("http")){const e=s.find(e=>a.startsWith(e));e&&!t.has(e)&&t.add(e)}}}function getStandardContext(){const e={rdf:namespaces_1.NsUrl.rdf,rdfs:namespaces_1.NsUrl.rdfs,xsd:namespaces_1.NsUrl.xsd,dc:namespaces_1.NsUrl.dc,soa:namespaces_1.NsUrl.soa};return[namespaces_1.SOA.superClassOf,namespaces_1.SOA.superPropertyOf,namespaces_1.SOA.hasProperty,namespaces_1.SOA.isRangeOf,namespaces_1.SOA.hasEnumerationMember,namespaces_1.SOA.enumerationDomainIncludes,namespaces_1.RDFS.subClassOf,namespaces_1.RDFS.subPropertyOf,namespaces_1.SCHEMA.isPartOf,namespaces_1.SCHEMA.domainIncludes,namespaces_1.SCHEMA.rangeIncludes,namespaces_1.SCHEMA.supersededBy,namespaces_1.SCHEMA.inverseOf,namespaces_1.SCHEMA.source,namespaces_1.DC.source].map(s=>{e[s]={"@id":s,"@type":"@id"}}),e}exports.curateVocabNode=curateVocabNode,exports.generateContext=generateContext,exports.preProcessVocab=preProcessVocab,exports.discoverUsedSchemaOrgProtocol=discoverUsedSchemaOrgProtocol,exports.discoverEquateNamespaces=discoverEquateNamespaces,exports.checkIfNamespaceFromListIsUsed=checkIfNamespaceFromListIsUsed,exports.getStandardContext=getStandardContext;

},{"./namespaces":12,"./utilities":14,"jsonld":61}],11:[function(_dereq_,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,r,i){return new(r||(r=Promise))(function(a,c){function n(e){try{s(i.next(e))}catch(e){c(e)}}function o(e){try{s(i.throw(e))}catch(e){c(e)}}function s(e){var t;e.done?a(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(n,o)}s((i=i.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.constructURLSchemaVocabulary=exports.getLatestSchemaVersion=exports.fetchSchemaVersions=exports.create=void 0;const SDOAdapter_1=_dereq_("./SDOAdapter"),utilities_1=_dereq_("./utilities");function create(e){return __awaiter(this,void 0,void 0,function*(){const t=new SDOAdapter_1.SDOAdapter(e);if(e&&e.schemaVersion){const r=yield(0,utilities_1.constructURLSchemaVocabulary)(e.schemaVersion,e.schemaHttps,e.commit);yield t.addVocabularies(r)}return e&&e.vocabularies&&(yield t.addVocabularies(e.vocabularies)),t})}exports.create=create;var utilities_2=_dereq_("./utilities");Object.defineProperty(exports,"fetchSchemaVersions",{enumerable:!0,get:function(){return utilities_2.fetchSchemaVersions}}),Object.defineProperty(exports,"getLatestSchemaVersion",{enumerable:!0,get:function(){return utilities_2.getLatestSchemaVersion}}),Object.defineProperty(exports,"constructURLSchemaVocabulary",{enumerable:!0,get:function(){return utilities_2.constructURLSchemaVocabulary}});

},{"./SDOAdapter":8,"./utilities":14}],12:[function(_dereq_,module,exports){
"use strict";function toCompactUri(e,r){return Object.freeze(Object.fromEntries(r.map(r=>[r,e+":"+r])))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.TermTypeIRI=exports.TermTypeLabel=exports.XSD=exports.DC=exports.SCHEMA=exports.SOA=exports.RDFS=exports.RDF=exports.NsPre=exports.NsUrl=void 0,exports.NsUrl={xsd:"http://www.w3.org/2001/XMLSchema#",rdf:"http://www.w3.org/1999/02/22-rdf-syntax-ns#",rdfs:"http://www.w3.org/2000/01/rdf-schema#",schema:"https://schema.org/",dc:"http://purl.org/dc/terms/",soa:"http://schema-org-adapter.at/vocabTerms/"},exports.NsPre={xsd:"xsd",rdf:"rdf",rdfs:"rdfs",schema:"schema",dc:"dc",soa:"soa"},exports.RDF=toCompactUri(exports.NsPre.rdf,["Property"]),exports.RDFS=toCompactUri("rdfs",["Class","subClassOf","subPropertyOf","label","comment"]),exports.SOA=toCompactUri("soa",["EnumerationMember","superClassOf","superPropertyOf","hasProperty","isRangeOf","hasEnumerationMember","enumerationDomainIncludes"]),exports.SCHEMA=toCompactUri("schema",["DataType","Enumeration","isPartOf","domainIncludes","rangeIncludes","supersededBy","inverseOf","source","category"]),exports.DC=toCompactUri("dc",["source"]),exports.XSD=toCompactUri("xsd",["string","decimal","integer","float","double","boolean","date","time","dateTime","anyURI"]),exports.TermTypeLabel={class:"Class",property:"Property",enumeration:"Enumeration",enumerationMember:"EnumerationMember",dataType:"DataType"},exports.TermTypeIRI={class:"rdfs:Class",property:"rdf:Property",enumeration:"schema:Enumeration",enumerationMember:"soa:EnumerationMember",dataType:"schema:DataType"};

},{}],13:[function(_dereq_,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.inferRangeOf=exports.inferSubProperties=exports.inferSuperProperties=exports.inferSubDataTypes=exports.inferSuperDataTypes=exports.inferSubClasses=exports.inferSuperClasses=exports.inferPropertiesFromSuperClasses=exports.applyFilter=void 0;const utilities_1=_dereq_("./utilities"),namespaces_1=_dereq_("./namespaces");function applyFilter(e){const{data:s,filter:i,graph:t}=e;if(!Array.isArray(s)||0===s.length||!i||0===Object.keys(i).length)return s;const r=(0,utilities_1.uniquifyArray)(s),n=[],u=t.context;let o;if(i.fromVocabulary){o=(0,utilities_1.toArray)(i.fromVocabulary);for(let e=0;e<o.length;e++)for(let s=0;s<Object.keys(u).length;s++)if(u[Object.keys(u)[s]]===o[e]){o[e]=Object.keys(u)[s];break}}for(let e=0;e<r.length;e++){const s=t.getTerm(r[e]);if(s){if(void 0!==i.isSuperseded){if(!i.isSuperseded&&null!=s.isSupersededBy())continue;if(i.isSuperseded&&null==s.isSupersededBy())continue}if(o){let e=!1;for(let i=0;i<o.length;i++)if(s.getIRI(!0).startsWith(o[i])){e=!0;break}if(!e)continue}if(i.termType){const e=(0,utilities_1.toArray)(i.termType),t=e.find(e=>!Object.values(namespaces_1.TermTypeLabel).includes(e));if(t)throw new Error("Invalid filter.termType "+t);if(!e.find(e=>e===s.getTermTypeLabel()))continue}n.push(r[e])}}return n}function inferPropertiesFromSuperClasses(e,s){const i=[];for(const t of e){const e=s.classes[t]||s.enumerations[t];e&&(i.push(...e[namespaces_1.SOA.hasProperty]),0!==e[namespaces_1.RDFS.subClassOf].length&&i.push(...inferPropertiesFromSuperClasses(e[namespaces_1.RDFS.subClassOf],s)))}return(0,utilities_1.uniquifyArray)(i)}function inferSuperClasses(e,s){let i=[];const t=s.classes[e]||s.enumerations[e];if(t){i.push(...t[namespaces_1.RDFS.subClassOf]);let e=(0,utilities_1.cloneJson)(i);do{let t=[];for(const i of e){const e=s.classes[i]||s.enumerations[i];e&&t.push(...e[namespaces_1.RDFS.subClassOf])}t=(0,utilities_1.uniquifyArray)(t),e=(0,utilities_1.cloneJson)(t),i.push(...t)}while(0!==e.length);i=(0,utilities_1.uniquifyArray)(i)}return i}function inferSubClasses(e,s){let i=[];const t=s.classes[e]||s.enumerations[e];if(t){i.push(...t[namespaces_1.SOA.superClassOf]);let e=(0,utilities_1.cloneJson)(i);do{let t=[];for(const i of e){const e=s.classes[i]||s.enumerations[i];e&&t.push(...e[namespaces_1.SOA.superClassOf])}t=(0,utilities_1.uniquifyArray)(t),e=(0,utilities_1.cloneJson)(t),i.push(...t)}while(0!==e.length);i=(0,utilities_1.uniquifyArray)(i)}return i}function inferSuperDataTypes(e,s){let i=[];const t=s.dataTypes[e];if(t){i.push(...t[namespaces_1.RDFS.subClassOf]);let e=(0,utilities_1.cloneJson)(i);do{let t=[];for(const i of e){const e=s.dataTypes[i];e&&t.push(...e[namespaces_1.RDFS.subClassOf])}t=(0,utilities_1.uniquifyArray)(t),e=(0,utilities_1.cloneJson)(t),i.push(...t)}while(0!==e.length);i=(0,utilities_1.uniquifyArray)(i)}return i}function inferSubDataTypes(e,s){let i=[];const t=s.dataTypes[e];if(t){i.push(...t[namespaces_1.SOA.superClassOf]);let e=(0,utilities_1.cloneJson)(i);do{let t=[];for(const i of e){const e=s.dataTypes[i];e&&t.push(...e[namespaces_1.SOA.superClassOf])}t=(0,utilities_1.uniquifyArray)(t),e=(0,utilities_1.cloneJson)(t),i.push(...t)}while(0!==e.length);i=(0,utilities_1.uniquifyArray)(i)}return i}function inferSuperProperties(e,s){let i=[];const t=s.properties[e];if(t){i.push(...t[namespaces_1.RDFS.subPropertyOf]);let e=(0,utilities_1.cloneJson)(i);do{let t=[];for(const i of e){const e=s.properties[i];e&&t.push(...e[namespaces_1.RDFS.subPropertyOf])}t=(0,utilities_1.uniquifyArray)(t),e=(0,utilities_1.cloneJson)(t),i.push(...t)}while(0!==e.length);i=(0,utilities_1.uniquifyArray)(i)}return i}function inferSubProperties(e,s){let i=[];const t=s.properties[e];if(t){i.push(...t[namespaces_1.SOA.superPropertyOf]);let e=(0,utilities_1.cloneJson)(i);do{let t=[];for(const i of e){const e=s.properties[i];e&&t.push(...e[namespaces_1.SOA.superPropertyOf])}t=(0,utilities_1.uniquifyArray)(t),e=(0,utilities_1.cloneJson)(t),i.push(...t)}while(0!==e.length);i=(0,utilities_1.uniquifyArray)(i)}return i}function inferRangeOf(e,s){const i=s.classes[e]||s.enumerations[e],t=[];if(i){t.push(...i[namespaces_1.SOA.isRangeOf]);const r=inferSuperClasses(e,s);for(const e of r){const i=s.classes[e]||s.enumerations[e];i&&t.push(...i[namespaces_1.SOA.isRangeOf])}}else{const i=s.dataTypes[e];if(i){t.push(...i[namespaces_1.SOA.isRangeOf]);const r=inferSuperDataTypes(e,s);for(const e of r){const i=s.dataTypes[e];i&&t.push(...i[namespaces_1.SOA.isRangeOf])}}}return(0,utilities_1.uniquifyArray)(t)}exports.applyFilter=applyFilter,exports.inferPropertiesFromSuperClasses=inferPropertiesFromSuperClasses,exports.inferSuperClasses=inferSuperClasses,exports.inferSubClasses=inferSubClasses,exports.inferSuperDataTypes=inferSuperDataTypes,exports.inferSubDataTypes=inferSubDataTypes,exports.inferSuperProperties=inferSuperProperties,exports.inferSubProperties=inferSubProperties,exports.inferRangeOf=inferRangeOf;

},{"./namespaces":12,"./utilities":14}],14:[function(_dereq_,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,r,s){return new(r||(r=Promise))(function(o,a){function n(e){try{c(s.next(e))}catch(e){a(e)}}function i(e){try{c(s.throw(e))}catch(e){a(e)}}function c(e){var t;e.done?o(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(n,i)}c((s=s.apply(e,t||[])).next())})},__importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.getLatestSchemaVersion=exports.checkURL=exports.fetchSchemaVersions=exports.constructURLSchemaVocabulary=exports.getURLSchemaVersions=exports.getURLBaseSchema=exports.toArray=exports.switchIRIProtocol=exports.getFileNameForSchemaOrgVersion=exports.sortReleaseEntriesByDate=exports.toAbsoluteIRI=exports.toCompactIRI=exports.uniquifyArray=exports.isArray=exports.isString=exports.isNil=exports.isLanguageObjectVocab=exports.isObject=exports.cloneJson=void 0;const axios_1=__importDefault(_dereq_("axios")),RetrievalMemory_1=_dereq_("./RetrievalMemory"),myRetrievalMemory=RetrievalMemory_1.RetrievalMemory.getInstance();function cloneJson(e){return void 0===e?e:JSON.parse(JSON.stringify(e))}function isObject(e){return!Array.isArray(e)&&(!isNil(e)&&"object"==typeof e)}function isLanguageObjectVocab(e){return!!(isObject(e)&&isString(e["@language"])&&isString(e["@value"]))}function isNil(e){return null==e}function isString(e){return!isNil(e)&&("string"==typeof e||e instanceof String)}function isArray(e){return Array.isArray(e)}function uniquifyArray(e){return[...new Set(e)]}function toCompactIRI(e,t,r=!1){for(const s of Object.keys(t)){const o=t[s];if(isString(o)&&e.startsWith(o))return s+":"+e.substring(o.length);if(r&&isString(o)){const t=switchIRIProtocol(o);if(e.startsWith(t))return s+":"+e.substring(t.length)}}return null}function toAbsoluteIRI(e,t){const r=Object.keys(t);for(let s=0;s<r.length;s++){const o=t[r[s]];if(e.substring(0,e.indexOf(":"))===r[s])return o.concat(e.substring(e.indexOf(":")+1))}throw new Error("Trying to get an absolute IRI for a term with no entry in the Context")}function sortReleaseEntriesByDate(e){return Object.entries(e).sort((e,t)=>+new Date(t[1])-+new Date(e[1]))}function getFileNameForSchemaOrgVersion(e,t=!0){switch(e){case"2.0":case"2.1":case"2.2":case"3.0":throw new Error("There is no jsonld file for that schema.org version.");case"3.1":case"3.2":case"3.3":case"3.4":case"3.5":case"3.6":case"3.7":case"3.8":case"3.9":case"4.0":case"5.0":case"6.0":case"7.0":case"7.01":case"7.02":case"7.03":case"7.04":case"8.0":return"all-layers.jsonld";case"9.0":default:return t?"schemaorg-all-https.jsonld":"schemaorg-all-http.jsonld"}}function switchIRIProtocol(e){return e.startsWith("https://")?"http"+e.substring(5):e.startsWith("http://")?"https"+e.substring(4):e}exports.cloneJson=cloneJson,exports.isObject=isObject,exports.isLanguageObjectVocab=isLanguageObjectVocab,exports.isNil=isNil,exports.isString=isString,exports.isArray=isArray,exports.uniquifyArray=uniquifyArray,exports.toCompactIRI=toCompactIRI,exports.toAbsoluteIRI=toAbsoluteIRI,exports.sortReleaseEntriesByDate=sortReleaseEntriesByDate,exports.getFileNameForSchemaOrgVersion=getFileNameForSchemaOrgVersion,exports.switchIRIProtocol=switchIRIProtocol;const toArray=e=>Array.isArray(e)?e:[e];exports.toArray=toArray;const URI_SEMANTIFY_GITHUB="https://raw.githubusercontent.com/semantifyit/schemaorg/main",URI_SCHEMA_ORG_GITHUB="https://raw.githubusercontent.com/schemaorg/schemaorg/";function getURLBaseSchema(e){const t="/data/releases/";return e?URI_SCHEMA_ORG_GITHUB+e+t:URI_SEMANTIFY_GITHUB+t}function getURLSchemaVersions(e){const t="/versions.json";return e?URI_SCHEMA_ORG_GITHUB+e+t:URI_SEMANTIFY_GITHUB+t}function constructURLSchemaVocabulary(e="latest",t=!0,r){return __awaiter(this,void 0,void 0,function*(){"latest"===e&&(e=yield getLatestSchemaVersion(r));const s=getFileNameForSchemaOrgVersion(e,t);return getURLBaseSchema(r)+e+"/"+s})}function fetchSchemaVersions(e=!1,t){return __awaiter(this,void 0,void 0,function*(){let r;if(e)myRetrievalMemory.deleteCache();else{const e=myRetrievalMemory.getData("versionsFile",t);if(e)return e}const s=getURLSchemaVersions(t);try{r=yield axios_1.default.get(s)}catch(e){throw new Error("Unable to retrieve the schema.org versions file at "+s)}if(!r||!r.data||!r.data.releaseLog)throw new Error("The schema.org versions file at "+s+" returned an unexpected result.");const o=r.data;let a;if(myRetrievalMemory.setData("versionsFile",o,t),o.schemaversion&&(yield checkURL(yield constructURLSchemaVocabulary(o.schemaversion))))a=o.schemaversion;else{const e=sortReleaseEntriesByDate(o.releaseLog);for(const t of e)if(yield checkURL(yield constructURLSchemaVocabulary(t[0]))){a=t[0];break}}if(!a)throw new Error('Could not find any valid vocabulary file in the schema.org versions to be declared as "latest".');return myRetrievalMemory.setData("latest",a,t),o})}function checkURL(e){return __awaiter(this,void 0,void 0,function*(){try{return yield axios_1.default.head(e),!0}catch(e){return!1}})}function getLatestSchemaVersion(e){return __awaiter(this,void 0,void 0,function*(){let t=myRetrievalMemory.getData("latest",e);if(t||(yield fetchSchemaVersions(!1,e)),t=myRetrievalMemory.getData("latest",e))return t;throw new Error("Could not identify the latest version of the schema.org vocabulary")})}exports.getURLBaseSchema=getURLBaseSchema,exports.getURLSchemaVersions=getURLSchemaVersions,exports.constructURLSchemaVocabulary=constructURLSchemaVocabulary,exports.fetchSchemaVersions=fetchSchemaVersions,exports.checkURL=checkURL,exports.getLatestSchemaVersion=getLatestSchemaVersion;
