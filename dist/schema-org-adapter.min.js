...
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,s,r){return new(s||(s=Promise))(function(i,a){function n(e){try{h(r.next(e))}catch(e){a(e)}}function o(e){try{h(r.throw(e))}catch(e){a(e)}}function h(e){var t;e.done?i(e.value):(t=e.value,t instanceof s?t:new s(function(e){e(t)})).then(n,o)}h((r=r.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Graph=void 0;const Class_1=_dereq_("./Class"),Property_1=_dereq_("./Property"),Enumeration_1=_dereq_("./Enumeration"),EnumerationMember_1=_dereq_("./EnumerationMember"),DataType_1=_dereq_("./DataType"),utilities_1=_dereq_("./utilities"),namespaces_1=_dereq_("./namespaces"),graphUtilities_1=_dereq_("./graphUtilities"),reasoning_1=_dereq_("./reasoning");class Graph{constructor(e){this.sdoAdapter=e,this.context=(0,graphUtilities_1.getStandardContext)(),this.classes={},this.properties={},this.dataTypes={},this.enumerations={},this.enumerationMembers={}}addVocabulary(e,t){return __awaiter(this,void 0,void 0,function*(){void 0===this.context.schema&&(this.context.schema=(0,graphUtilities_1.discoverUsedSchemaOrgProtocol)(e)+"://schema.org/");try{if(this.sdoAdapter.equateVocabularyProtocols){const t=(0,graphUtilities_1.discoverEquateNamespaces)(this.context,e);if(t.length>0){const s=(0,utilities_1.cloneJson)(e["@context"]);t.forEach(e=>{const t=Object.keys(s).find(t=>s[t]===e);t&&delete s[t];const r=Object.keys(this.context).find(t=>this.context[t]===(0,utilities_1.switchIRIProtocol)(e));s[r]=e}),e=yield(0,graphUtilities_1.preProcessVocab)(e,s),t.forEach(t=>{const s=Object.keys(this.context).find(e=>this.context[e]===(0,utilities_1.switchIRIProtocol)(t));e["@context"][s]=this.context[s]})}}this.context=(0,graphUtilities_1.generateContext)(this.context,e["@context"]),e=yield(0,graphUtilities_1.preProcessVocab)(e,this.context);const s=this.sdoAdapter.getVocabularies();for(let t of e["@graph"])t=(0,graphUtilities_1.curateVocabNode)(t,s);for(let s=0;s<e["@graph"].length;s++){const r=(0,utilities_1.cloneJson)(e["@graph"][s]);if((0,utilities_1.isString)(r["@type"]))switch(r["@type"]){case namespaces_1.TermTypeIRI.class:this.addGraphNode(this.classes,r,t);break;case namespaces_1.TermTypeIRI.property:this.addGraphNode(this.properties,r,t);break;default:this.addGraphNode(this.enumerationMembers,r,t)}else(0,utilities_1.isArray)(r["@type"])?r["@type"].includes(namespaces_1.TermTypeIRI.class)&&r["@type"].includes(namespaces_1.TermTypeIRI.dataType)?this.addGraphNode(this.dataTypes,r,t):this.addGraphNode(this.enumerationMembers,r,t):this.sdoAdapter.onError("unexpected @type format for the following node: "+JSON.stringify(r,null,2))}(0,graphUtilities_1.extractFromClassMemory)(this.classes,this.enumerations,this.addGraphNode,t),(0,graphUtilities_1.extractFromClassMemory)(this.classes,this.dataTypes,this.addGraphNode,t),Object.values(this.dataTypes).forEach(e=>e["@type"]=namespaces_1.TermTypeIRI.dataType),(0,graphUtilities_1.addInheritanceTermsClassAndEnum)(this.classes,this.enumerations,namespaces_1.RDFS.subClassOf,namespaces_1.SOA.superClassOf),(0,graphUtilities_1.addInheritanceTermsClassAndEnum)(this.enumerations,this.enumerations,namespaces_1.RDFS.subClassOf,namespaces_1.SOA.superClassOf),(0,graphUtilities_1.addInheritanceTermsDataTypesAndProperties)(this.dataTypes,namespaces_1.RDFS.subClassOf,namespaces_1.SOA.superClassOf),(0,graphUtilities_1.addInheritanceTermsDataTypesAndProperties)(this.properties,namespaces_1.RDFS.subPropertyOf,namespaces_1.SOA.superPropertyOf),Object.values(this.classes).forEach(e=>{(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.hasProperty),(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.isRangeOf)}),Object.values(this.enumerations).forEach(e=>{(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.hasEnumerationMember),(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.isRangeOf),(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.hasProperty)}),Object.values(this.dataTypes).forEach(e=>{(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.isRangeOf)}),Object.values(this.enumerationMembers).forEach(e=>{(0,graphUtilities_1.addEmptyArray)(e,namespaces_1.SOA.enumerationDomainIncludes)});const r=Object.keys(this.properties);for(const e of r){const t=this.properties[e][namespaces_1.SCHEMA.domainIncludes];if((0,utilities_1.isArray)(t))for(const s of t){let t=this.classes[s];t||(t=this.enumerations[s]),t&&(0,utilities_1.isArray)(t[namespaces_1.SOA.hasProperty])&&!t[namespaces_1.SOA.hasProperty].includes(e)&&t[namespaces_1.SOA.hasProperty].push(e)}const s=this.properties[e][namespaces_1.SCHEMA.rangeIncludes];if((0,utilities_1.isArray)(s))for(const t of s){const s=this.classes[t]||this.enumerations[t]||this.dataTypes[t];s&&(0,utilities_1.isArray)(s[namespaces_1.SOA.isRangeOf])&&!s[namespaces_1.SOA.isRangeOf].includes(e)&&s[namespaces_1.SOA.isRangeOf].push(e)}}const i=Object.keys(this.enumerationMembers);for(const e of i){const t=this.enumerationMembers[e];let s=t["@type"];(0,utilities_1.isArray)(s)||(s=[s]);for(const r of s){const s=this.enumerations[r];s&&(0,utilities_1.isArray)(s[namespaces_1.SOA.hasEnumerationMember])&&!s[namespaces_1.SOA.hasEnumerationMember].includes(e)&&(s[namespaces_1.SOA.hasEnumerationMember].push(e),(0,utilities_1.isArray)(t[namespaces_1.SOA.enumerationDomainIncludes])?t[namespaces_1.SOA.enumerationDomainIncludes].push(r):t[namespaces_1.SOA.enumerationDomainIncludes]=[r])}}return!0}catch(e){return this.sdoAdapter.onError(e),!1}})}addGraphNode(e,t,s){try{if(e[t["@id"]]){const r=e[t["@id"]];(0,graphUtilities_1.nodeMergeOverwrite)(r,t,namespaces_1.SCHEMA.isPartOf),(0,graphUtilities_1.nodeMergeOverwrite)(r,t,namespaces_1.DC.source),(0,graphUtilities_1.nodeMergeOverwrite)(r,t,namespaces_1.SCHEMA.source),(0,graphUtilities_1.nodeMergeOverwrite)(r,t,namespaces_1.SCHEMA.category),(0,graphUtilities_1.nodeMergeOverwrite)(r,t,namespaces_1.SCHEMA.supersededBy),(0,graphUtilities_1.nodeMergeLanguageTerm)(r,t,namespaces_1.RDFS.label),(0,graphUtilities_1.nodeMergeLanguageTerm)(r,t,namespaces_1.RDFS.comment),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.RDFS.subClassOf),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SOA.superClassOf),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SOA.hasProperty),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SOA.isRangeOf),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SOA.enumerationDomainIncludes),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SOA.hasEnumerationMember),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.RDFS.subPropertyOf),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SCHEMA.domainIncludes),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SCHEMA.rangeIncludes),(0,graphUtilities_1.nodeMergeAddIds)(r,t,namespaces_1.SOA.superPropertyOf),s&&(r.vocabURLs?r.vocabURLs.includes(s)||r.vocabURLs.push(s):r.vocabURLs=[s])}else e[t["@id"]]=t,s&&(e[t["@id"]].vocabURLs=[s]);return!0}catch(e){return this.sdoAdapter.onError(e),!1}}getTerm(e,t){const s=this.discoverCompactIRI(e);if(!s)throw new Error("There is no term with the IRI "+e);let r,i,a=0;do{switch(a){case 0:r=this.classes[s],i="Class";break;case 1:r=this.properties[s],i="Property";break;case 2:r=this.dataTypes[s],i="DataType";break;case 3:r=this.enumerations[s],i="Enumeration";break;case 4:r=this.enumerationMembers[s],i="EnumerationMember"}a++}while(!r&&a<6);if(!r||!i)throw new Error("There is no term with the IRI "+e);if(0===(r=(0,reasoning_1.applyFilter)({data:[r["@id"]],filter:t,graph:this})).length)throw new Error("There is no term with that IRI and filter settings.");switch(i){case"Class":return new Class_1.Class(s,this);case"Property":return new Property_1.Property(s,this);case"Enumeration":return new Enumeration_1.Enumeration(s,this);case"EnumerationMember":return new EnumerationMember_1.EnumerationMember(s,this);case"DataType":return new DataType_1.DataType(s,this)}throw new Error("targetType with unknown value: "+i)}getClass(e,t){const s=this.discoverCompactIRI(e);if(s){let e=this.classes[s];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[s],filter:t,graph:this})).length)throw new Error("There is no class with that IRI and filter settings.");return new Class_1.Class(s,this)}if(e=this.enumerations[s])try{return this.getEnumeration(s,t)}catch(e){throw new Error("There is no class with that IRI and filter settings.")}}throw new Error("There is no class with the IRI "+e)}getProperty(e,t){const s=this.discoverCompactIRI(e);if(s){let e=this.properties[s];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[s],filter:t,graph:this})).length)throw new Error("There is no property with that URI and filter settings.");return new Property_1.Property(s,this)}}throw new Error("There is no property with that URI.")}getDataType(e,t){const s=this.discoverCompactIRI(e);if(s){let e=this.dataTypes[s];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[s],filter:t,graph:this})).length)throw new Error("There is no data-type with that IRI and filter settings.");return new DataType_1.DataType(s,this)}}throw new Error("There is no data-type with the IRI "+e)}getEnumeration(e,t){const s=this.discoverCompactIRI(e);if(s){let e=this.enumerations[s];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[s],filter:t,graph:this})).length)throw new Error("There is no enumeration with that IRI and filter settings.");return new Enumeration_1.Enumeration(s,this)}}throw new Error("There is no enumeration with the IRI "+e)}getEnumerationMember(e,t){const s=this.discoverCompactIRI(e);if(s){let e=this.enumerationMembers[s];if(e){if(0===(e=(0,reasoning_1.applyFilter)({data:[s],filter:t,graph:this})).length)throw new Error("There is no EnumerationMember with that IRI and filter settings.");return new EnumerationMember_1.EnumerationMember(s,this)}}throw new Error("There is no EnumerationMember with the IRI "+e)}discoverCompactIRI(e){if(e.includes(":")){const t=Object.keys(this.context);for(const s of t){const t=this.context[s];if((0,utilities_1.isString)(t)){if(e.startsWith(s))return e;if(e.startsWith(t)||this.sdoAdapter.equateVocabularyProtocols&&e.startsWith((0,utilities_1.switchIRIProtocol)(t)))try{return(0,utilities_1.toCompactIRI)(e,this.context,this.sdoAdapter.equateVocabularyProtocols)}catch(e){return null}}}}else{const t=Object.keys(this.classes);for(const s of t)if(this.containsLabel(this.classes[s],e))return s;const s=Object.keys(this.properties);for(const t of s)if(this.containsLabel(this.properties[t],e))return t;const r=Object.keys(this.dataTypes);for(const t of r)if(this.containsLabel(this.dataTypes[t],e))return t;const i=Object.keys(this.enumerations);for(const t of i)if(this.containsLabel(this.enumerations[t],e))return t;const a=Object.keys(this.enumerationMembers);for(const t of a)if(this.containsLabel(this.enumerationMembers[t],e))return t}return null}containsLabel(e,t){if(e&&(0,utilities_1.isObject)(e[namespaces_1.RDFS.label])){const s=Object.keys(e[namespaces_1.RDFS.label]);for(const r of s)if(e[namespaces_1.RDFS.label][r]===t)return!0}return!1}}exports.Graph=Graph;
...
"use strict";var __awaiter=this&&this.__awaiter||function(e,s,t,r){return new(t||(t=Promise))(function(a,n){function i(e){try{o(r.next(e))}catch(e){n(e)}}function c(e){try{o(r.throw(e))}catch(e){n(e)}}function o(e){var s;e.done?a(e.value):(s=e.value,s instanceof t?s:new t(function(e){e(s)})).then(i,c)}o((r=r.apply(e,s||[])).next())})},__importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.nodeMergeAddIds=exports.nodeMergeLanguageTerm=exports.nodeMergeOverwrite=exports.addEmptyArray=exports.addInheritanceTermsDataTypesAndProperties=exports.addInheritanceTermsClassAndEnum=exports.extractFromClassMemory=exports.getStandardContext=exports.checkIfNamespaceFromListIsUsed=exports.discoverEquateNamespaces=exports.discoverUsedSchemaOrgProtocol=exports.preProcessVocab=exports.generateContext=exports.curateVocabNode=void 0;const namespaces_1=_dereq_("./namespaces"),utilities_1=_dereq_("./utilities"),jsonld_1=__importDefault(_dereq_("jsonld"));function curateLanguageTerm(e,s){if(void 0!==e[s]){if((0,utilities_1.isString)(e[s]))e[s]={en:e[s]};else if((0,utilities_1.isLanguageObjectVocab)(e[s]))e[s]={[e[s]["@language"]]:e[s]["@value"]};else if((0,utilities_1.isArray)(e[s])){const t={};e[s].map(e=>{(0,utilities_1.isLanguageObjectVocab)(e)&&(t[e["@language"]]=e["@value"])}),e[s]=t}}else e[s]={}}function curateRelationshipTermArray(e,s,t){(0,utilities_1.isString)(e[s])?e[s]=[e[s]]:void 0===e[s]&&e["@type"]===t&&(e[s]=[])}function curateVocabNode(e,s){if(curateLanguageTerm(e,namespaces_1.RDFS.comment),curateLanguageTerm(e,namespaces_1.RDFS.label),curateRelationshipTermArray(e,namespaces_1.RDFS.subClassOf,namespaces_1.TermTypeIRI.class),curateRelationshipTermArray(e,namespaces_1.RDFS.subPropertyOf,namespaces_1.TermTypeIRI.property),curateRelationshipTermArray(e,namespaces_1.SCHEMA.domainIncludes,namespaces_1.TermTypeIRI.property),curateRelationshipTermArray(e,namespaces_1.SCHEMA.rangeIncludes,namespaces_1.TermTypeIRI.property),void 0===e[namespaces_1.SCHEMA.inverseOf]&&e["@type"]===namespaces_1.TermTypeIRI.property&&(e[namespaces_1.SCHEMA.inverseOf]=null),!(0,utilities_1.isString)(e[namespaces_1.SCHEMA.isPartOf])){let t=Object.keys(s).find(s=>e["@id"].substring(0,e["@id"].indexOf(":"))===s);if((0,utilities_1.isString)(t)){let r;t=s[t];do{r=!1,(t.endsWith("/")||t.endsWith("#"))&&(t=t.substring(0,t.length-1),r=!0)}while(r);e[namespaces_1.SCHEMA.isPartOf]=t}}return e}function generateContext(e,s){const t=Object.keys(e),r=Object.keys(s);let a=(0,utilities_1.cloneJson)(e);for(const e of r)if((0,utilities_1.isString)(s[e])){let r=!1;for(const n of t)if((0,utilities_1.isString)(a[n])&&a[n]===s[e]){r=!0;break}if(r)continue;if(a[e]){if(a[e]!==s[e]){let t=!1,r=1;for(;!t;){const n=e+r++;a[n]||(t=!0,a[n]=s[e])}}}else a[e]=s[e]}const n={};Object.keys(a).sort().forEach(function(e){n[e]=a[e]}),a=n;const i=Object.keys(a),c={};for(const e of i)(0,utilities_1.isString)(a[e])&&(c[e]=a[e]);for(const e of i)(0,utilities_1.isObject)(a[e])&&(c[e]=a[e]);return c}function preProcessVocab(e,s){return __awaiter(this,void 0,void 0,function*(){let t=!1;do{const s=[];t=!1;for(let r=0;r<e["@graph"].length;r++)void 0!==e["@graph"][r]["@graph"]?(s.push(...(0,utilities_1.cloneJson)(e["@graph"][r]["@graph"])),t=!0):s.push((0,utilities_1.cloneJson)(e["@graph"][r]));e["@graph"]=(0,utilities_1.cloneJson)(s)}while(t);const r=yield jsonld_1.default.compact(e,s);return void 0===r["@graph"]?(delete r["@context"],{"@context":s,"@graph":[r]}):r})}function discoverUsedSchemaOrgProtocol(e){const s="https://schema.org/",t="http://schema.org/";if(e["@context"])for(const r of Object.values(e["@context"]))if((0,utilities_1.isObject)(r)&&r["@vocab"]){if(r["@vocab"]===s)return"https";if(r["@vocab"]===t)return"http"}else if((0,utilities_1.isString)(r)){if(r===s)return"https";if(r===t)return"http"}const r=JSON.stringify(e),a=r.split(s).length-1,n=r.split(t).length-1;return a>n?"https":n>a?"http":s}function discoverEquateNamespaces(e,s){const t=new Set,r=[];return Object.values(e).forEach(function(e){(0,utilities_1.isString)(e)&&r.push((0,utilities_1.switchIRIProtocol)(e))}),s["@context"]&&Object.values(s["@context"]).forEach(function(e){(0,utilities_1.isString)(e)&&r.includes(e)&&t.add(e)}),Array.isArray(s["@graph"])&&s["@graph"].forEach(function(e){checkIfNamespaceFromListIsUsed(e["@id"],r,t),checkIfNamespaceFromListIsUsed(e["@type"],r,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.RDFS.subClassOf],r,t),checkIfNamespaceFromListIsUsed(e["http://www.w3.org/2000/01/rdf-schema#subClassOf"],r,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.SCHEMA.domainIncludes],r,t),checkIfNamespaceFromListIsUsed(e["http://schema.org/domainIncludes"],r,t),checkIfNamespaceFromListIsUsed(e["https://schema.org/domainIncludes"],r,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.SCHEMA.rangeIncludes],r,t),checkIfNamespaceFromListIsUsed(e["http://schema.org/rangeIncludes"],r,t),checkIfNamespaceFromListIsUsed(e["https://schema.org/rangeIncludes"],r,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.RDFS.subPropertyOf],r,t),checkIfNamespaceFromListIsUsed(e["http://www.w3.org/2000/01/rdf-schema#subPropertyOf"],r,t),checkIfNamespaceFromListIsUsed(e[namespaces_1.SCHEMA.inverseOf],r,t),checkIfNamespaceFromListIsUsed(e["http://schema.org/inverseOf"],r,t),checkIfNamespaceFromListIsUsed(e["https://schema.org/inverseOf"],r,t)}),Array.from(t)}function checkIfNamespaceFromListIsUsed(e,s,t){if(Array.isArray(e))e.forEach(function(e){checkIfNamespaceFromListIsUsed(e,s,t)});else{let r;if(r=(0,utilities_1.isObject)(e)&&(0,utilities_1.isString)(e["@id"])?e["@id"]:e,(0,utilities_1.isString)(r)&&r.startsWith("http")){const e=s.find(e=>r.startsWith(e));e&&!t.has(e)&&t.add(e)}}}function getStandardContext(){const e={rdf:namespaces_1.NsUrl.rdf,rdfs:namespaces_1.NsUrl.rdfs,xsd:namespaces_1.NsUrl.xsd,dc:namespaces_1.NsUrl.dc,soa:namespaces_1.NsUrl.soa};return[namespaces_1.SOA.superClassOf,namespaces_1.SOA.superPropertyOf,namespaces_1.SOA.hasProperty,namespaces_1.SOA.isRangeOf,namespaces_1.SOA.hasEnumerationMember,namespaces_1.SOA.enumerationDomainIncludes,namespaces_1.RDFS.subClassOf,namespaces_1.RDFS.subPropertyOf,namespaces_1.SCHEMA.isPartOf,namespaces_1.SCHEMA.domainIncludes,namespaces_1.SCHEMA.rangeIncludes,namespaces_1.SCHEMA.supersededBy,namespaces_1.SCHEMA.inverseOf,namespaces_1.SCHEMA.source,namespaces_1.DC.source].map(s=>{e[s]={"@id":s,"@type":"@id"}}),e}function extractFromClassMemory(e,s,t,r){let a;do{a=!1;const n=Object.keys(e),i=Object.keys(s);for(const c of n)if(void 0!==e[c][namespaces_1.RDFS.subClassOf]){const n=e[c][namespaces_1.RDFS.subClassOf];for(const o of n)(o===namespaces_1.TermTypeIRI.enumeration||i.includes(o))&&(e[c]&&!s[c]?(a=!0,s[c]=(0,utilities_1.cloneJson)(e[c]),delete e[c]):e[c]&&s[c]&&(a=!0,t(s,e[c],r),delete e[c]))}}while(a)}function addInheritanceTermsClassAndEnum(e,s,t,r){const a=Object.keys(e);for(const n of a){const a=e[n][t];e[n][r]||(e[n][r]=[]);for(const t of a){let a=e[t];a||(a=s[t]),a&&(a[r]?a[r].includes(n)||a[r].push(n):a[r]=[n])}}}function addInheritanceTermsDataTypesAndProperties(e,s,t){const r=Object.keys(e);for(const a of r){const r=e[a][s];if(e[a][t]||(e[a][t]=[]),r)for(const s of r){const r=e[s];r&&(r[t]?r[t].includes(a)||r[t].push(a):r[t]=[a])}else e[a][s]=[]}}function addEmptyArray(e,s){e[s]||(e[s]=[])}function nodeMergeOverwrite(e,s,t){(0,utilities_1.isNil)(s[t])||(e[t]=s[t])}function nodeMergeLanguageTerm(e,s,t){if(!(0,utilities_1.isNil)(s[t])){const r=Object.keys(s[t]);for(const a of r)e[t][a]=s[t][a]}}function nodeMergeAddIds(e,s,t){if(!(0,utilities_1.isNil)(s[t]))for(const r of s[t])e[t].includes(r)||e[t].push(r)}exports.curateVocabNode=curateVocabNode,exports.generateContext=generateContext,exports.preProcessVocab=preProcessVocab,exports.discoverUsedSchemaOrgProtocol=discoverUsedSchemaOrgProtocol,exports.discoverEquateNamespaces=discoverEquateNamespaces,exports.checkIfNamespaceFromListIsUsed=checkIfNamespaceFromListIsUsed,exports.getStandardContext=getStandardContext,exports.extractFromClassMemory=extractFromClassMemory,exports.addInheritanceTermsClassAndEnum=addInheritanceTermsClassAndEnum,exports.addInheritanceTermsDataTypesAndProperties=addInheritanceTermsDataTypesAndProperties,exports.addEmptyArray=addEmptyArray,exports.nodeMergeOverwrite=nodeMergeOverwrite,exports.nodeMergeLanguageTerm=nodeMergeLanguageTerm,exports.nodeMergeAddIds=nodeMergeAddIds;
