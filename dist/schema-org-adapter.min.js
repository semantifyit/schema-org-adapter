...
"use strict";function asyncGeneratorStep(e,t,r,n,a,s,i){try{var o=e[s](i),l=o.value}catch(e){return void r(e)}o.done?t(l):Promise.resolve(l).then(n,a)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,a){var s=e.apply(t,r);function i(e){asyncGeneratorStep(s,n,a,i,o,"next",e)}function o(e){asyncGeneratorStep(s,n,a,i,o,"throw",e)}i(void 0)})}}var Graph=_dereq_("./Graph"),util=_dereq_("./utilities"),axios=_dereq_("axios"),RETRIEVAL_MEMORY={versionsFile:null,latest:null},URI_SDO_GITHUB="https://raw.githubusercontent.com/schemaorg/schemaorg/master/",URI_SDO_RELEASES=URI_SDO_GITHUB+"data/releases/",URI_SDO_VERSIONS=URI_SDO_GITHUB+"versions.json";class SDOAdapter{constructor(){this.graph=new Graph(this)}addVocabularies(e){var t=this;return _asyncToGenerator(function*(){if(!util.isArray(e))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD)");for(var r=0;r<e.length;r++)if(util.isString(e[r]))if(e[r].startsWith("www")||e[r].startsWith("http")){var n=yield t.fetchVocabularyFromURL(e[r]);try{yield t.graph.addVocabulary(n)}catch(t){console.log("The given URL "+e[r]+" did not contain a valid JSON-LD vocabulary.")}}else try{yield t.graph.addVocabulary(JSON.parse(e[r]))}catch(e){console.log("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!util.isObject(e[r]))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD as Object/String)");yield t.graph.addVocabulary(e[r])}})()}fetchVocabularyFromURL(e){return _asyncToGenerator(function*(){try{return new Promise(function(t,r){axios.get(e).then(function(e){t(e.data)}).catch(function(e){r(console.log(e))})})}catch(e){return console.log(e),""}})()}getClass(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getClass(e,t)}getAllClasses(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t=this.getListOfClasses(e),r=[],n=0;n<t.length;n++)try{r.push(this.getClass(t[n]))}catch(e){throw new Error("There is no class with the IRI "+t[n])}return r}getListOfClasses(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.classes),e,this.graph)}getProperty(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getProperty(e,t)}getAllProperties(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t=this.getListOfProperties(e),r=[],n=0;n<t.length;n++)try{r.push(this.getProperty(t[n]))}catch(e){throw new Error("There is no property with the IRI "+t[n])}return r}getListOfProperties(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.properties),e,this.graph)}getDataType(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getDataType(e,t)}getAllDataTypes(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t=this.getListOfDataTypes(e),r=[],n=0;n<t.length;n++)try{r.push(this.getDataType(t[n]))}catch(e){throw new Error("There is no data type with the IRI "+t[n])}return r}getListOfDataTypes(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.dataTypes),e,this.graph)}getEnumeration(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumeration(e,t)}getAllEnumerations(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t=this.getListOfEnumerations(e),r=[],n=0;n<t.length;n++)try{r.push(this.getEnumeration(t[n]))}catch(e){throw new Error("There is no enumeration with the IRI "+t[n])}return r}getListOfEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerations),e,this.graph)}getEnumerationMember(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumerationMember(e,t)}getAllEnumerationMembers(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t=this.getListOfEnumerationMembers(e),r=[],n=0;n<t.length;n++)try{r.push(this.getEnumerationMember(t[n]))}catch(e){throw new Error("There is no enumeration member with the IRI "+t[n])}return r}getListOfEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerationMembers),e,this.graph)}getVocabularies(){for(var e=Object.keys(this.graph.context),t={},r=["soa","xsd","rdf","rdfa","rdfs","dc"],n=0;n<e.length;n++)util.isString(this.graph.context[e[n]])&&-1===r.indexOf(e[n])&&(t[e[n]]=this.graph.context[e[n]]);return t}constructSDOVocabularyURL(){var e=arguments,t=this;return _asyncToGenerator(function*(){var r=e.length>0&&void 0!==e[0]?e[0]:"latest",n=e.length>1&&void 0!==e[1]?e[1]:"schema";if("latest"!==r)return URI_SDO_RELEASES+r+"/"+n+".jsonld";try{return RETRIEVAL_MEMORY.versionsFile||(yield t.getSDOVersionFile()),URI_SDO_RELEASES+RETRIEVAL_MEMORY.latest+"/"+n+".jsonld"}catch(e){throw console.log("Could not determine/retrieve the latest version of schema.org"),e}})()}getSDOVersionFile(){var e=this;return _asyncToGenerator(function*(){var t;try{t=yield axios.get(URI_SDO_VERSIONS)}catch(e){throw console.log("Unable to retrieve the schema.org versions file at "+URI_SDO_VERSIONS),e}if(t&&t.data){if(RETRIEVAL_MEMORY.versionsFile=t.data,RETRIEVAL_MEMORY.versionsFile.schemaversion){if(yield e.checkURL(URI_SDO_RELEASES+RETRIEVAL_MEMORY.versionsFile.schemaversion+"/all-layers.jsonld"))RETRIEVAL_MEMORY.latest=RETRIEVAL_MEMORY.versionsFile.schemaversion;else if(RETRIEVAL_MEMORY.versionsFile.releaseLog)for(var r=Object.keys(RETRIEVAL_MEMORY.versionsFile.releaseLog).sort(),n=r.length-1;n>=0;n--)if(yield e.checkURL(URI_SDO_RELEASES+r[n]+"/all-layers.jsonld")){RETRIEVAL_MEMORY.latest=r[n];break}return}throw console.log("Schema.org versions file has an unexpected structure -> "+URI_SDO_VERSIONS),new Error("Schema.org versions file has an unexpected structure!")}})()}checkURL(e){return _asyncToGenerator(function*(){try{return yield axios.head(e),!0}catch(e){return!1}})()}getLatestSDOVersion(){var e=this;return _asyncToGenerator(function*(){return RETRIEVAL_MEMORY.latest||(yield e.getSDOVersionFile()),RETRIEVAL_MEMORY.latest})()}}module.exports=SDOAdapter;

},{"./Graph":78,"./utilities":82,"axios":1}],82:[function(_dereq_,module,exports){
"use strict";function asyncGeneratorStep(r,e,a,s,t,n,o){try{var i=r[n](o),f=i.value}catch(r){return void a(r)}i.done?e(f):Promise.resolve(f).then(s,t)}function _asyncToGenerator(r){return function(){var e=this,a=arguments;return new Promise(function(s,t){var n=r.apply(e,a);function o(r){asyncGeneratorStep(n,s,t,o,i,"next",r)}function i(r){asyncGeneratorStep(n,s,t,o,i,"throw",r)}o(void 0)})}}var jsonld=_dereq_("jsonld");function applyFilter(r,e,a){if(!Array.isArray(r)||0===r.length||null===e||0===Object.keys(e).length)return r;var s=[],t=a.context;if(isString(e.fromVocabulary)){for(var n=0;n<Object.keys(t).length;n++)if(t[Object.keys(t)[n]]===e.fromVocabulary){e.fromVocabulary=Object.keys(t)[n];break}}else if(isArray(e.fromVocabulary))for(var o=0;o<e.fromVocabulary.length;o++)for(var i=0;i<Object.keys(t).length;i++)if(t[Object.keys(t)[i]]===e.fromVocabulary[o]){e.fromVocabulary[o]=Object.keys(t)[i];break}for(var f=0;f<r.length;f++){var c=a.getTerm(r[f]);if(void 0!==e.isSuperseded){if(!1===e.isSuperseded&&null!=c.isSupersededBy())continue;if(!0===e.isSuperseded&&null==c.isSupersededBy())continue}if(void 0!==e.fromVocabulary){var l=!1;if(isString(e.fromVocabulary))e.fromVocabulary&&c.getIRI(!0).startsWith(e.fromVocabulary)&&(l=!0);else if(isArray(e.fromVocabulary))for(var u=0;u<e.fromVocabulary.length;u++)c.getIRI(!0).startsWith(e.fromVocabulary[u])&&(l=!0);if(!l)continue}if(void 0!==e.termType){var d=!1,y=[];isString(e.termType)?y.push(e.termType):isArray(e.termType)&&(y=e.termType);for(var b=0;b<y.length;b++){var m=void 0;switch(y[b]){case"Class":m="rdfs:Class";break;case"Property":m="rdf:Property";break;case"Enumeration":m="schema:Enumeration";break;case"EnumerationMember":m="soa:EnumerationMember";break;case"DataType":m="schema:DataType";break;default:console.log("Invalid filter.termType "+y[b])}if(m===c.getTermType()){d=!0;break}}if(!d)continue}s.push(r[f])}return s}function copByVal(r){if(void 0!==r)return JSON.parse(JSON.stringify(r))}function isObject(r){return!Array.isArray(r)&&(null!=r&&"object"==typeof r)}function isString(r){return null!=r&&("string"==typeof r||r instanceof String)}function isArray(r){return Array.isArray(r)}function uniquifyArray(r){for(var e={},a=[],s=0;s<r.length;s++){var t=r[s];1!==e[t]&&(e[t]=1,a.push(t))}return a}function generateContext(r,e){for(var a=Object.keys(r),s=Object.keys(e),t=JSON.parse(JSON.stringify(r)),n=0;n<s.length;n++){var o=s[n];if(isString(e[o])){for(var i=!1,f=0;f<a.length;f++)if(isString(t[a[f]])&&t[a[f]]===e[o]){i=!0;break}if(i)continue;if(void 0===t[o])t[o]=e[o];else if(t[o]!==e[o])for(var c=!1,l=1;!1===c;){var u=o+l++;void 0===t[u]&&(c=!0,t[u]=e[o])}}}var d={};Object.keys(t).sort().forEach(function(r){d[r]=t[r]}),t=d;for(var y=Object.keys(t),b={},m=0;m<y.length;m++)isString(t[y[m]])&&(b[y[m]]=t[y[m]]);for(var p=0;p<y.length;p++)isObject(t[y[p]])&&(b[y[p]]=t[y[p]]);return b}function preProcessVocab(r,e){return _preProcessVocab.apply(this,arguments)}function _preProcessVocab(){return(_preProcessVocab=_asyncToGenerator(function*(r,e){var a=!1;do{var s=[];a=!1;for(var t=0;t<r["@graph"].length;t++)void 0!==r["@graph"][t]["@graph"]?(s.push(...copByVal(r["@graph"][t]["@graph"])),a=!0):s.push(copByVal(r["@graph"][t]));r["@graph"]=copByVal(s)}while(!0===a);var n=yield jsonld.expand(r),o=yield jsonld.compact(n,e);return void 0===o["@graph"]?(delete o["@context"],{"@context":e,"@graph":[o]}):o})).apply(this,arguments)}function curateVocabNode(r,e){if(void 0!==r["rdfs:comment"]){if(isString(r["rdfs:comment"]))r["rdfs:comment"]={en:r["rdfs:comment"]};else if(isObject(r["rdfs:comment"])){var a={};a[r["rdfs:comment"]["@language"]]=r["rdfs:comment"]["@value"],r["rdfs:comment"]=copByVal(a)}else if(isArray(r["rdfs:comment"])){for(var s={},t=0;t<r["rdfs:comment"].length;t++)isObject(r["rdfs:comment"][t])&&(s[r["rdfs:comment"][t]["@language"]]=r["rdfs:comment"][t]["@value"]);r["rdfs:comment"]=copByVal(s)}}else r["rdfs:comment"]={};if(void 0!==r["rdfs:label"]){if(isString(r["rdfs:label"]))r["rdfs:label"]={en:r["rdfs:label"]};else if(isObject(r["rdfs:label"])){var n={};n[r["rdfs:label"]["@language"]]=r["rdfs:label"]["@value"],r["rdfs:label"]=copByVal(n)}else if(isArray(r["rdfs:label"])){for(var o={},i=0;i<r["rdfs:label"].length;i++)isObject(r["rdfs:label"][i])&&(o[r["rdfs:label"][i]["@language"]]=r["rdfs:label"][i]["@value"]);r["rdfs:label"]=copByVal(o)}}else r["rdfs:label"]={};if(isString(r["rdfs:subClassOf"])?r["rdfs:subClassOf"]=[r["rdfs:subClassOf"]]:void 0===r["rdfs:subClassOf"]&&"rdfs:Class"===r["@type"]&&(r["rdfs:subClassOf"]=[]),isString(r["rdfs:subPropertyOf"])?r["rdfs:subPropertyOf"]=[r["rdfs:subPropertyOf"]]:void 0===r["rdfs:subPropertyOf"]&&"rdf:Property"===r["@type"]&&(r["rdfs:subPropertyOf"]=[]),isString(r["schema:domainIncludes"])?r["schema:domainIncludes"]=[r["schema:domainIncludes"]]:void 0===r["schema:domainIncludes"]&&"rdf:Property"===r["@type"]&&(r["schema:domainIncludes"]=[]),isString(r["schema:rangeIncludes"])?r["schema:rangeIncludes"]=[r["schema:rangeIncludes"]]:void 0===r["schema:rangeIncludes"]&&"rdf:Property"===r["@type"]&&(r["schema:rangeIncludes"]=[]),!isString(r["schema:isPartOf"])){for(var f,c=Object.keys(e),l=0;l<c.length;l++)if(r["@id"].substring(0,r["@id"].indexOf(":"))===c[l]){f=e[c[l]];break}if(void 0!==f){var u;do{u=!1,(f.endsWith("/")||f.endsWith("#"))&&(f=f.substring(0,f.length-1),u=!0)}while(!0===u);r["schema:isPartOf"]=f}}return r}function toCompactIRI(r,e){for(var a=Object.keys(e),s=0;s<a.length;s++){var t=e[a[s]];if(isString(t)&&r.startsWith(t))return a[s]+":"+r.substring(t.length)}return null}function toAbsoluteIRI(r,e){for(var a=Object.keys(e),s=0;s<a.length;s++){var t=e[a[s]];if(r.substring(0,r.indexOf(":"))===a[s])return t.concat(r.substring(r.indexOf(":")+1))}return null}module.exports={applyFilter:applyFilter,copByVal:copByVal,isArray:isArray,isString:isString,isObject:isObject,uniquifyArray:uniquifyArray,preProcessVocab:preProcessVocab,generateContext:generateContext,curateVocabNode:curateVocabNode,toCompactIRI:toCompactIRI,toAbsoluteIRI:toAbsoluteIRI};
