...
"use strict";function asyncGeneratorStep(e,r,t,a,i,n,o){try{var s=e[n](o),l=s.value}catch(e){return void t(e)}s.done?r(l):Promise.resolve(l).then(a,i)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise(function(a,i){var n=e.apply(r,t);function o(e){asyncGeneratorStep(n,a,i,o,s,"next",e)}function s(e){asyncGeneratorStep(n,a,i,o,s,"throw",e)}o(void 0)})}}var Graph=_dereq_("./Graph"),util=_dereq_("./utilities"),axios=_dereq_("axios"),URI_SDO_GITHUB="https://raw.githubusercontent.com/schemaorg/schemaorg/main/",URI_SDO_RELEASES=URI_SDO_GITHUB+"data/releases/",URI_SDO_VERSIONS=URI_SDO_GITHUB+"versions.json";class SDOAdapter{constructor(){this.graph=new Graph(this),this.retrievalMemory={versionsFile:null,latest:null}}addVocabularies(e){var r=this;return _asyncToGenerator(function*(){if(!util.isArray(e))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD)");for(var t=0;t<e.length;t++)if(util.isString(e[t]))if(e[t].startsWith("www")||e[t].startsWith("http")){var a=yield r.fetchVocabularyFromURL(e[t]);try{yield r.graph.addVocabulary(a)}catch(r){console.log("The given URL "+e[t]+" did not contain a valid JSON-LD vocabulary.")}}else try{yield r.graph.addVocabulary(JSON.parse(e[t]))}catch(e){console.log("Parsing of vocabulary string produced an invalid JSON-LD.")}else{if(!util.isObject(e[t]))throw new Error("The first argument of the function must be an Array of vocabularies (JSON-LD as Object/String)");yield r.graph.addVocabulary(e[t])}})()}fetchVocabularyFromURL(e){return _asyncToGenerator(function*(){try{return new Promise(function(r,t){axios.get(e).then(function(e){r(e.data)}).catch(function(e){t(console.log(e))})})}catch(e){return console.log(e),""}})()}getClass(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getClass(e,r)}getAllClasses(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=this.getListOfClasses(e),t=[],a=0;a<r.length;a++)try{t.push(this.getClass(r[a]))}catch(e){throw new Error("There is no class with the IRI "+r[a])}return t}getListOfClasses(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.classes),e,this.graph)}getProperty(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getProperty(e,r)}getAllProperties(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=this.getListOfProperties(e),t=[],a=0;a<r.length;a++)try{t.push(this.getProperty(r[a]))}catch(e){throw new Error("There is no property with the IRI "+r[a])}return t}getListOfProperties(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.properties),e,this.graph)}getDataType(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getDataType(e,r)}getAllDataTypes(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=this.getListOfDataTypes(e),t=[],a=0;a<r.length;a++)try{t.push(this.getDataType(r[a]))}catch(e){throw new Error("There is no data type with the IRI "+r[a])}return t}getListOfDataTypes(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.dataTypes),e,this.graph)}getEnumeration(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumeration(e,r)}getAllEnumerations(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=this.getListOfEnumerations(e),t=[],a=0;a<r.length;a++)try{t.push(this.getEnumeration(r[a]))}catch(e){throw new Error("There is no enumeration with the IRI "+r[a])}return t}getListOfEnumerations(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerations),e,this.graph)}getEnumerationMember(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null;return this.graph.getEnumerationMember(e,r)}getAllEnumerationMembers(){for(var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=this.getListOfEnumerationMembers(e),t=[],a=0;a<r.length;a++)try{t.push(this.getEnumerationMember(r[a]))}catch(e){throw new Error("There is no enumeration member with the IRI "+r[a])}return t}getListOfEnumerationMembers(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return util.applyFilter(Object.keys(this.graph.enumerationMembers),e,this.graph)}getVocabularies(){for(var e=Object.keys(this.graph.context),r={},t=["soa","xsd","rdf","rdfa","rdfs","dc"],a=0;a<e.length;a++)util.isString(this.graph.context[e[a]])&&-1===t.indexOf(e[a])&&(r[e[a]]=this.graph.context[e[a]]);return r}constructSDOVocabularyURL(){var e=arguments,r=this;return _asyncToGenerator(function*(){var t=e.length>0&&void 0!==e[0]?e[0]:"latest";if("latest"===t)try{r.retrievalMemory.versionsFile||(yield r.getSDOVersionFile(),t=r.retrievalMemory.latest)}catch(e){throw console.error("Could not determine/retrieve the latest version of schema.org"),e}var a=util.getFileNameForSchemaOrgVersion(t);return URI_SDO_RELEASES+t+"/"+a})()}getSDOVersionFile(){var e=this;return _asyncToGenerator(function*(){var r;try{r=yield axios.get(URI_SDO_VERSIONS)}catch(e){throw console.log("Unable to retrieve the schema.org versions file at "+URI_SDO_VERSIONS),e}if(r&&r.data){if(e.retrievalMemory.versionsFile=r.data,e.retrievalMemory.versionsFile.schemaversion){if(yield e.checkURL(yield e.constructSDOVocabularyURL(e.retrievalMemory.versionsFile.schemaversion)))e.retrievalMemory.latest=e.retrievalMemory.versionsFile.schemaversion;else{if(e.retrievalMemory.versionsFile.releaseLog){var t=util.sortReleaseEntriesByDate(e.retrievalMemory.versionsFile.releaseLog);for(var a of t)if(yield e.checkURL(yield e.constructSDOVocabularyURL(a[0]))){e.retrievalMemory.latest=a[0];break}}if(!e.retrievalMemory.latest){var i='Could not find any valid vocabulary file in the Schema.org versions file (to be declared as "latest".';throw console.log(i),new Error(i)}}return}var n="Schema.org versions file has an unexpected structure!";throw console.log(n+" -> "+URI_SDO_VERSIONS),new Error(n)}})()}checkURL(e){return _asyncToGenerator(function*(){try{return yield axios.head(e),!0}catch(e){return!1}})()}getLatestSDOVersion(){var e=this;return _asyncToGenerator(function*(){return e.retrievalMemory.latest||(yield e.getSDOVersionFile()),e.retrievalMemory.latest})()}}module.exports=SDOAdapter;

},{"./Graph":78,"./utilities":82,"axios":1}],82:[function(_dereq_,module,exports){
"use strict";function asyncGeneratorStep(e,r,a,s,t,n,o){try{var i=e[n](o),c=i.value}catch(e){return void a(e)}i.done?r(c):Promise.resolve(c).then(s,t)}function _asyncToGenerator(e){return function(){var r=this,a=arguments;return new Promise(function(s,t){var n=e.apply(r,a);function o(e){asyncGeneratorStep(n,s,t,o,i,"next",e)}function i(e){asyncGeneratorStep(n,s,t,o,i,"throw",e)}o(void 0)})}}var jsonld=_dereq_("jsonld");function applyFilter(e,r,a){if(!Array.isArray(e)||0===e.length||null===r||0===Object.keys(r).length)return e;var s=[],t=a.context;if(isString(r.fromVocabulary)){for(var n=0;n<Object.keys(t).length;n++)if(t[Object.keys(t)[n]]===r.fromVocabulary){r.fromVocabulary=Object.keys(t)[n];break}}else if(isArray(r.fromVocabulary))for(var o=0;o<r.fromVocabulary.length;o++)for(var i=0;i<Object.keys(t).length;i++)if(t[Object.keys(t)[i]]===r.fromVocabulary[o]){r.fromVocabulary[o]=Object.keys(t)[i];break}for(var c=0;c<e.length;c++){var l=a.getTerm(e[c]);if(void 0!==r.isSuperseded){if(!1===r.isSuperseded&&null!=l.isSupersededBy())continue;if(!0===r.isSuperseded&&null==l.isSupersededBy())continue}if(void 0!==r.fromVocabulary){var f=!1;if(isString(r.fromVocabulary))r.fromVocabulary&&l.getIRI(!0).startsWith(r.fromVocabulary)&&(f=!0);else if(isArray(r.fromVocabulary))for(var u=0;u<r.fromVocabulary.length;u++)l.getIRI(!0).startsWith(r.fromVocabulary[u])&&(f=!0);if(!f)continue}if(void 0!==r.termType){var d=!1,y=[];isString(r.termType)?y.push(r.termType):isArray(r.termType)&&(y=r.termType);for(var b=0;b<y.length;b++){var m=void 0;switch(y[b]){case"Class":m="rdfs:Class";break;case"Property":m="rdf:Property";break;case"Enumeration":m="schema:Enumeration";break;case"EnumerationMember":m="soa:EnumerationMember";break;case"DataType":m="schema:DataType";break;default:console.log("Invalid filter.termType "+y[b])}if(m===l.getTermType()){d=!0;break}}if(!d)continue}s.push(e[c])}return s}function copByVal(e){if(void 0!==e)return JSON.parse(JSON.stringify(e))}function isObject(e){return!Array.isArray(e)&&(null!=e&&"object"==typeof e)}function isString(e){return null!=e&&("string"==typeof e||e instanceof String)}function isArray(e){return Array.isArray(e)}function uniquifyArray(e){for(var r={},a=[],s=0;s<e.length;s++){var t=e[s];1!==r[t]&&(r[t]=1,a.push(t))}return a}function generateContext(e,r){for(var a=Object.keys(e),s=Object.keys(r),t=JSON.parse(JSON.stringify(e)),n=0;n<s.length;n++){var o=s[n];if(isString(r[o])){for(var i=!1,c=0;c<a.length;c++)if(isString(t[a[c]])&&t[a[c]]===r[o]){i=!0;break}if(i)continue;if(void 0===t[o])t[o]=r[o];else if(t[o]!==r[o])for(var l=!1,f=1;!1===l;){var u=o+f++;void 0===t[u]&&(l=!0,t[u]=r[o])}}}var d={};Object.keys(t).sort().forEach(function(e){d[e]=t[e]}),t=d;for(var y=Object.keys(t),b={},m=0;m<y.length;m++)isString(t[y[m]])&&(b[y[m]]=t[y[m]]);for(var g=0;g<y.length;g++)isObject(t[y[g]])&&(b[y[g]]=t[y[g]]);return b}function preProcessVocab(e,r){return _preProcessVocab.apply(this,arguments)}function _preProcessVocab(){return(_preProcessVocab=_asyncToGenerator(function*(e,r){var a=!1;do{var s=[];a=!1;for(var t=0;t<e["@graph"].length;t++)void 0!==e["@graph"][t]["@graph"]?(s.push(...copByVal(e["@graph"][t]["@graph"])),a=!0):s.push(copByVal(e["@graph"][t]));e["@graph"]=copByVal(s)}while(!0===a);var n=yield jsonld.expand(e),o=yield jsonld.compact(n,r);return void 0===o["@graph"]?(delete o["@context"],{"@context":r,"@graph":[o]}):o})).apply(this,arguments)}function curateVocabNode(e,r){if(void 0!==e["rdfs:comment"]){if(isString(e["rdfs:comment"]))e["rdfs:comment"]={en:e["rdfs:comment"]};else if(isObject(e["rdfs:comment"])){var a={};a[e["rdfs:comment"]["@language"]]=e["rdfs:comment"]["@value"],e["rdfs:comment"]=copByVal(a)}else if(isArray(e["rdfs:comment"])){for(var s={},t=0;t<e["rdfs:comment"].length;t++)isObject(e["rdfs:comment"][t])&&(s[e["rdfs:comment"][t]["@language"]]=e["rdfs:comment"][t]["@value"]);e["rdfs:comment"]=copByVal(s)}}else e["rdfs:comment"]={};if(void 0!==e["rdfs:label"]){if(isString(e["rdfs:label"]))e["rdfs:label"]={en:e["rdfs:label"]};else if(isObject(e["rdfs:label"])){var n={};n[e["rdfs:label"]["@language"]]=e["rdfs:label"]["@value"],e["rdfs:label"]=copByVal(n)}else if(isArray(e["rdfs:label"])){for(var o={},i=0;i<e["rdfs:label"].length;i++)isObject(e["rdfs:label"][i])&&(o[e["rdfs:label"][i]["@language"]]=e["rdfs:label"][i]["@value"]);e["rdfs:label"]=copByVal(o)}}else e["rdfs:label"]={};if(isString(e["rdfs:subClassOf"])?e["rdfs:subClassOf"]=[e["rdfs:subClassOf"]]:void 0===e["rdfs:subClassOf"]&&"rdfs:Class"===e["@type"]&&(e["rdfs:subClassOf"]=[]),isString(e["rdfs:subPropertyOf"])?e["rdfs:subPropertyOf"]=[e["rdfs:subPropertyOf"]]:void 0===e["rdfs:subPropertyOf"]&&"rdf:Property"===e["@type"]&&(e["rdfs:subPropertyOf"]=[]),isString(e["schema:domainIncludes"])?e["schema:domainIncludes"]=[e["schema:domainIncludes"]]:void 0===e["schema:domainIncludes"]&&"rdf:Property"===e["@type"]&&(e["schema:domainIncludes"]=[]),isString(e["schema:rangeIncludes"])?e["schema:rangeIncludes"]=[e["schema:rangeIncludes"]]:void 0===e["schema:rangeIncludes"]&&"rdf:Property"===e["@type"]&&(e["schema:rangeIncludes"]=[]),!isString(e["schema:isPartOf"])){for(var c,l=Object.keys(r),f=0;f<l.length;f++)if(e["@id"].substring(0,e["@id"].indexOf(":"))===l[f]){c=r[l[f]];break}if(void 0!==c){var u;do{u=!1,(c.endsWith("/")||c.endsWith("#"))&&(c=c.substring(0,c.length-1),u=!0)}while(!0===u);e["schema:isPartOf"]=c}}return e}function toCompactIRI(e,r){for(var a=Object.keys(r),s=0;s<a.length;s++){var t=r[a[s]];if(isString(t)&&e.startsWith(t))return a[s]+":"+e.substring(t.length)}return null}function toAbsoluteIRI(e,r){for(var a=Object.keys(r),s=0;s<a.length;s++){var t=r[a[s]];if(e.substring(0,e.indexOf(":"))===a[s])return t.concat(e.substring(e.indexOf(":")+1))}return null}function sortReleaseEntriesByDate(e){return Object.entries(e).sort((e,r)=>new Date(r[1])-new Date(e[1]))}function getFileNameForSchemaOrgVersion(e){switch(e){case"2.0":case"2.1":case"2.2":case"3.0":throw new Error("There is no jsonld file for that schema.org version.");case"3.1":case"3.2":case"3.3":case"3.4":case"3.5":case"3.6":case"3.7":case"3.8":case"3.9":case"4.0":case"5.0":case"6.0":case"7.0":case"7.01":case"7.02":case"7.03":case"7.04":case"8.0":return"all-layers.jsonld";case"9.0":default:return"schemaorg-all-http.jsonld"}}module.exports={applyFilter:applyFilter,copByVal:copByVal,isArray:isArray,isString:isString,isObject:isObject,uniquifyArray:uniquifyArray,preProcessVocab:preProcessVocab,generateContext:generateContext,curateVocabNode:curateVocabNode,toCompactIRI:toCompactIRI,toAbsoluteIRI:toAbsoluteIRI,sortReleaseEntriesByDate:sortReleaseEntriesByDate,getFileNameForSchemaOrgVersion:getFileNameForSchemaOrgVersion};
