...
class Enumeration {
     ...
     */
    getVocabulary() {
        let enumObj = this.graph.enumerations[this.IRI];
     ...
     */
    getName(language = "en") {
        let nameObj = this.graph.enumerations[this.IRI]["rdfs:label"];
    ...
    getDescription(language = "en") {
        let descriptionObj = this.graph.enumerations[this.IRI]["rdfs:comment"];
    ...
    getEnumerationMembers(filter = null) {
        let enumObj = this.graph.enumerations[this.IRI];
        let result = enumObj["soa:hasEnumerationMember"];
